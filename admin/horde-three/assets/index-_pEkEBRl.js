...
#define LOW_PRECISION`),t}function Df(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===xo?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===ec?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===an&&(t="SHADOWMAP_TYPE_VSM"),t}function If(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case ci:case li:t="ENVMAP_TYPE_CUBE";break;case vr:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Uf(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case li:t="ENVMAP_MODE_REFRACTION";break}return t}function Nf(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Vs:t="ENVMAP_BLENDING_MULTIPLY";break;case Mc:t="ENVMAP_BLENDING_MIX";break;case Sc:t="ENVMAP_BLENDING_ADD";break}return t}function Ff(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function Of(i,t,e,n){const r=i.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const c=Df(e),l=If(e),h=Uf(e),d=Nf(e),f=Ff(e),m=Tf(e),v=Af(s),x=r.createProgram();let p,u,T=e.glslVersion?"#version "+e.glslVersion+`
...
}`;function ep(i,t,e){let n=new js;const r=new qt,s=new qt,a=new ae,o=new jf({depthPacking:Lc}),c=new Jf,l={},h=e.maxTextureSize,d={[Sn]:Ee,[Ee]:Sn,[Ne]:Ne},f=new yn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new qt},radius:{value:4}},vertexShader:Qf,fragmentShader:tp}),m=f.clone();m.defines.HORIZONTAL_PASS=1;const v=new Fe;v.setAttribute("position",new qe(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new te(v,f),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=xo;let u=this.type;this.render=function(b,w,P){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||b.length===0)return;const y=i.getRenderTarget(),M=i.getActiveCubeFace(),R=i.getActiveMipmapLevel(),z=i.state;z.setBlending(xn),z.buffers.color.setClear(1,1,1,1),z.buffers.depth.setTest(!0),z.setScissorTest(!1);const L=u!==an&&this.type===an,G=u===an&&this.type!==an;for(let K=0,W=b.length;K<W;K++){const tt=b[K],D=tt.shadow;if(D===void 0){console.warn("THREE.WebGLShadowMap:",tt,"has no shadow.");continue}if(D.autoUpdate===!1&&D.needsUpdate===!1)continue;r.copy(D.mapSize);const et=D.getFrameExtents();if(r.multiply(et),s.copy(D.mapSize),(r.x>h||r.y>h)&&(r.x>h&&(s.x=Math.floor(h/et.x),r.x=s.x*et.x,D.mapSize.x=s.x),r.y>h&&(s.y=Math.floor(h/et.y),r.y=s.y*et.y,D.mapSize.y=s.y)),D.map===null||L===!0||G===!0){const ut=this.type!==an?{minFilter:Ce,magFilter:Ce}:{};D.map!==null&&D.map.dispose(),D.map=new Bn(r.x,r.y,ut),D.map.texture.name=tt.name+".shadowMap",D.camera.updateProjectionMatrix()}i.setRenderTarget(D.map),i.clear();const it=D.getViewportCount();for(let ut=0;ut<it;ut++){const vt=D.getViewport(ut);a.set(s.x*vt.x,s.y*vt.y,s.x*vt.z,s.y*vt.w),z.viewport(a),D.updateMatrices(tt,ut),n=D.getFrustum(),_(w,P,D.camera,tt,this.type)}D.isPointLightShadow!==!0&&this.type===an&&T(D,P),D.needsUpdate=!1}u=this.type,p.needsUpdate=!1,i.setRenderTarget(y,M,R)};function T(b,w){const P=t.update(x);f.defines.VSM_SAMPLES!==b.blurSamples&&(f.defines.VSM_SAMPLES=b.blurSamples,m.defines.VSM_SAMPLES=b.blurSamples,f.needsUpdate=!0,m.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new Bn(r.x,r.y)),f.uniforms.shadow_pass.value=b.map.texture,f.uniforms.resolution.value=b.mapSize,f.uniforms.radius.value=b.radius,i.setRenderTarget(b.mapPass),i.clear(),i.renderBufferDirect(w,null,P,f,x,null),m.uniforms.shadow_pass.value=b.mapPass.texture,m.uniforms.resolution.value=b.mapSize,m.uniforms.radius.value=b.radius,i.setRenderTarget(b.map),i.clear(),i.renderBufferDirect(w,null,P,m,x,null)}function A(b,w,P,y){let M=null;const R=P.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(R!==void 0)M=R;else if(M=P.isPointLight===!0?c:o,i.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0){const z=M.uuid,L=w.uuid;let G=l[z];G===void 0&&(G={},l[z]=G);let K=G[L];K===void 0&&(K=M.clone(),G[L]=K,w.addEventListener("dispose",B)),M=K}if(M.visible=w.visible,M.wireframe=w.wireframe,y===an?M.side=w.shadowSide!==null?w.shadowSide:w.side:M.side=w.shadowSide!==null?w.shadowSide:d[w.side],M.alphaMap=w.alphaMap,M.alphaTest=w.alphaTest,M.map=w.map,M.clipShadows=w.clipShadows,M.clippingPlanes=w.clippingPlanes,M.clipIntersection=w.clipIntersection,M.displacementMap=w.displacementMap,M.displacementScale=w.displacementScale,M.displacementBias=w.displacementBias,M.wireframeLinewidth=w.wireframeLinewidth,M.linewidth=w.linewidth,P.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const z=i.properties.get(M);z.light=P}return M}function _(b,w,P,y,M){if(b.visible===!1)return;if(b.layers.test(w.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&M===an)&&(!b.frustumCulled||n.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(P.matrixWorldInverse,b.matrixWorld);const L=t.update(b),G=b.material;if(Array.isArray(G)){const K=L.groups;for(let W=0,tt=K.length;W<tt;W++){const D=K[W],et=G[D.materialIndex];if(et&&et.visible){const it=A(b,et,y,M);b.onBeforeShadow(i,b,w,P,L,it,D),i.renderBufferDirect(P,null,L,it,b,D),b.onAfterShadow(i,b,w,P,L,it,D)}}}else if(G.visible){const K=A(b,G,y,M);b.onBeforeShadow(i,b,w,P,L,K,null),i.renderBufferDirect(P,null,L,K,b,null),b.onAfterShadow(i,b,w,P,L,K,null)}}const z=b.children;for(let L=0,G=z.length;L<G;L++)_(z[L],w,P,y,M)}function B(b){b.target.removeEventListener("dispose",B);for(const P in l){const y=l[P],M=b.target.uuid;M in y&&(y[M].dispose(),delete y[M])}}}const np={[ns]:is,[rs]:os,[ss]:cs,[oi]:as,[is]:ns,[os]:rs,[cs]:ss,[as]:oi};function ip(i,t){function e(){let C=!1;const ft=new ae;let q=null;const Q=new ae(0,0,0,0);return{setMask:function(mt){q!==mt&&!C&&(i.colorMask(mt,mt,mt,mt),q=mt)},setLocked:function(mt){C=mt},setClear:function(mt,nt,yt,Jt,ce){ce===!0&&(mt*=Jt,nt*=Jt,yt*=Jt),ft.set(mt,nt,yt,Jt),Q.equals(ft)===!1&&(i.clearColor(mt,nt,yt,Jt),Q.copy(ft))},reset:function(){C=!1,q=null,Q.set(-1,0,0,0)}}}function n(){let C=!1,ft=!1,q=null,Q=null,mt=null;return{setReversed:function(nt){if(ft!==nt){const yt=t.get("EXT_clip_control");ft?yt.clipControlEXT(yt.LOWER_LEFT_EXT,yt.ZERO_TO_ONE_EXT):yt.clipControlEXT(yt.LOWER_LEFT_EXT,yt.NEGATIVE_ONE_TO_ONE_EXT);const Jt=mt;mt=null,this.setClear(Jt)}ft=nt},getReversed:function(){return ft},setTest:function(nt){nt?ht(i.DEPTH_TEST):Lt(i.DEPTH_TEST)},setMask:function(nt){q!==nt&&!C&&(i.depthMask(nt),q=nt)},setFunc:function(nt){if(ft&&(nt=np[nt]),Q!==nt){switch(nt){case ns:i.depthFunc(i.NEVER);break;case is:i.depthFunc(i.ALWAYS);break;case rs:i.depthFunc(i.LESS);break;case oi:i.depthFunc(i.LEQUAL);break;case ss:i.depthFunc(i.EQUAL);break;case as:i.depthFunc(i.GEQUAL);break;case os:i.depthFunc(i.GREATER);break;case cs:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}Q=nt}},setLocked:function(nt){C=nt},setClear:function(nt){mt!==nt&&(ft&&(nt=1-nt),i.clearDepth(nt),mt=nt)},reset:function(){C=!1,q=null,Q=null,mt=null,ft=!1}}}function r(){let C=!1,ft=null,q=null,Q=null,mt=null,nt=null,yt=null,Jt=null,ce=null;return{setTest:function(Wt){C||(Wt?ht(i.STENCIL_TEST):Lt(i.STENCIL_TEST))},setMask:function(Wt){ft!==Wt&&!C&&(i.stencilMask(Wt),ft=Wt)},setFunc:function(Wt,Se,Je){(q!==Wt||Q!==Se||mt!==Je)&&(i.stencilFunc(Wt,Se,Je),q=Wt,Q=Se,mt=Je)},setOp:function(Wt,Se,Je){(nt!==Wt||yt!==Se||Jt!==Je)&&(i.stencilOp(Wt,Se,Je),nt=Wt,yt=Se,Jt=Je)},setLocked:function(Wt){C=Wt},setClear:function(Wt){ce!==Wt&&(i.clearStencil(Wt),ce=Wt)},reset:function(){C=!1,ft=null,q=null,Q=null,mt=null,nt=null,yt=null,Jt=null,ce=null}}}const s=new e,a=new n,o=new r,c=new WeakMap,l=new WeakMap;let h={},d={},f=new WeakMap,m=[],v=null,x=!1,p=null,u=null,T=null,A=null,_=null,B=null,b=null,w=new Vt(0,0,0),P=0,y=!1,M=null,R=null,z=null,L=null,G=null;const K=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let W=!1,tt=0;const D=i.getParameter(i.VERSION);D.indexOf("WebGL")!==-1?(tt=parseFloat(/^WebGL (\d)/.exec(D)[1]),W=tt>=1):D.indexOf("OpenGL ES")!==-1&&(tt=parseFloat(/^OpenGL ES (\d)/.exec(D)[1]),W=tt>=2);let et=null,it={};const ut=i.getParameter(i.SCISSOR_BOX),vt=i.getParameter(i.VIEWPORT),Rt=new ae().fromArray(ut),X=new ae().fromArray(vt);function J(C,ft,q,Q){const mt=new Uint8Array(4),nt=i.createTexture();i.bindTexture(C,nt),i.texParameteri(C,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(C,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let yt=0;yt<q;yt++)C===i.TEXTURE_3D||C===i.TEXTURE_2D_ARRAY?i.texImage3D(ft,0,i.RGBA,1,1,Q,0,i.RGBA,i.UNSIGNED_BYTE,mt):i.texImage2D(ft+yt,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,mt);return nt}const Et={};Et[i.TEXTURE_2D]=J(i.TEXTURE_2D,i.TEXTURE_2D,1),Et[i.TEXTURE_CUBE_MAP]=J(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),Et[i.TEXTURE_2D_ARRAY]=J(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),Et[i.TEXTURE_3D]=J(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),ht(i.DEPTH_TEST),a.setFunc(oi),dt(!1),ot(ua),ht(i.CULL_FACE),N(xn);function ht(C){h[C]!==!0&&(i.enable(C),h[C]=!0)}function Lt(C){h[C]!==!1&&(i.disable(C),h[C]=!1)}function Nt(C,ft){return d[C]!==ft?(i.bindFramebuffer(C,ft),d[C]=ft,C===i.DRAW_FRAMEBUFFER&&(d[i.FRAMEBUFFER]=ft),C===i.FRAMEBUFFER&&(d[i.DRAW_FRAMEBUFFER]=ft),!0):!1}function Ht(C,ft){let q=m,Q=!1;if(C){q=f.get(ft),q===void 0&&(q=[],f.set(ft,q));const mt=C.textures;if(q.length!==mt.length||q[0]!==i.COLOR_ATTACHMENT0){for(let nt=0,yt=mt.length;nt<yt;nt++)q[nt]=i.COLOR_ATTACHMENT0+nt;q.length=mt.length,Q=!0}}else q[0]!==i.BACK&&(q[0]=i.BACK,Q=!0);Q&&i.drawBuffers(q)}function ee(C){return v!==C?(i.useProgram(C),v=C,!0):!1}const Gt={[In]:i.FUNC_ADD,[ic]:i.FUNC_SUBTRACT,[rc]:i.FUNC_REVERSE_SUBTRACT};Gt[sc]=i.MIN,Gt[ac]=i.MAX;const se={[oc]:i.ZERO,[cc]:i.ONE,[lc]:i.SRC_COLOR,[ts]:i.SRC_ALPHA,[mc]:i.SRC_ALPHA_SATURATE,[fc]:i.DST_COLOR,[hc]:i.DST_ALPHA,[uc]:i.ONE_MINUS_SRC_COLOR,[es]:i.ONE_MINUS_SRC_ALPHA,[pc]:i.ONE_MINUS_DST_COLOR,[dc]:i.ONE_MINUS_DST_ALPHA,[gc]:i.CONSTANT_COLOR,[_c]:i.ONE_MINUS_CONSTANT_COLOR,[vc]:i.CONSTANT_ALPHA,[xc]:i.ONE_MINUS_CONSTANT_ALPHA};function N(C,ft,q,Q,mt,nt,yt,Jt,ce,Wt){if(C===xn){x===!0&&(Lt(i.BLEND),x=!1);return}if(x===!1&&(ht(i.BLEND),x=!0),C!==nc){if(C!==p||Wt!==y){if((u!==In||_!==In)&&(i.blendEquation(i.FUNC_ADD),u=In,_=In),Wt)switch(C){case ri:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ha:i.blendFunc(i.ONE,i.ONE);break;case da:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case fa:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",C);break}else switch(C){case ri:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ha:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case da:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case fa:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",C);break}T=null,A=null,B=null,b=null,w.set(0,0,0),P=0,p=C,y=Wt}return}mt=mt||ft,nt=nt||q,yt=yt||Q,(ft!==u||mt!==_)&&(i.blendEquationSeparate(Gt[ft],Gt[mt]),u=ft,_=mt),(q!==T||Q!==A||nt!==B||yt!==b)&&(i.blendFuncSeparate(se[q],se[Q],se[nt],se[yt]),T=q,A=Q,B=nt,b=yt),(Jt.equals(w)===!1||ce!==P)&&(i.blendColor(Jt.r,Jt.g,Jt.b,ce),w.copy(Jt),P=ce),p=C,y=!1}function O(C,ft){C.side===Ne?Lt(i.CULL_FACE):ht(i.CULL_FACE);let q=C.side===Ee;ft&&(q=!q),dt(q),C.blending===ri&&C.transparent===!1?N(xn):N(C.blending,C.blendEquation,C.blendSrc,C.blendDst,C.blendEquationAlpha,C.blendSrcAlpha,C.blendDstAlpha,C.blendColor,C.blendAlpha,C.premultipliedAlpha),a.setFunc(C.depthFunc),a.setTest(C.depthTest),a.setMask(C.depthWrite),s.setMask(C.colorWrite);const Q=C.stencilWrite;o.setTest(Q),Q&&(o.setMask(C.stencilWriteMask),o.setFunc(C.stencilFunc,C.stencilRef,C.stencilFuncMask),o.setOp(C.stencilFail,C.stencilZFail,C.stencilZPass)),Ct(C.polygonOffset,C.polygonOffsetFactor,C.polygonOffsetUnits),C.alphaToCoverage===!0?ht(i.SAMPLE_ALPHA_TO_COVERAGE):Lt(i.SAMPLE_ALPHA_TO_COVERAGE)}function dt(C){M!==C&&(C?i.frontFace(i.CW):i.frontFace(i.CCW),M=C)}function ot(C){C!==Qo?(ht(i.CULL_FACE),C!==R&&(C===ua?i.cullFace(i.BACK):C===tc?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Lt(i.CULL_FACE),R=C}function lt(C){C!==z&&(W&&i.lineWidth(C),z=C)}function Ct(C,ft,q){C?(ht(i.POLYGON_OFFSET_FILL),(L!==ft||G!==q)&&(i.polygonOffset(ft,q),L=ft,G=q)):Lt(i.POLYGON_OFFSET_FILL)}function gt(C){C?ht(i.SCISSOR_TEST):Lt(i.SCISSOR_TEST)}function E(C){C===void 0&&(C=i.TEXTURE0+K-1),et!==C&&(i.activeTexture(C),et=C)}function g(C,ft,q){q===void 0&&(et===null?q=i.TEXTURE0+K-1:q=et);let Q=it[q];Q===void 0&&(Q={type:void 0,texture:void 0},it[q]=Q),(Q.type!==C||Q.texture!==ft)&&(et!==q&&(i.activeTexture(q),et=q),i.bindTexture(C,ft||Et[C]),Q.type=C,Q.texture=ft)}function F(){const C=it[et];C!==void 0&&C.type!==void 0&&(i.bindTexture(C.type,null),C.type=void 0,C.texture=void 0)}function Z(){try{i.compressedTexImage2D.apply(i,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function $(){try{i.compressedTexImage3D.apply(i,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function Y(){try{i.texSubImage2D.apply(i,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function Mt(){try{i.texSubImage3D.apply(i,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function at(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function ct(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function Ut(){try{i.texStorage2D.apply(i,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function rt(){try{i.texStorage3D.apply(i,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function St(){try{i.texImage2D.apply(i,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function Pt(){try{i.texImage3D.apply(i,arguments)}catch(C){console.error("THREE.WebGLState:",C)}}function Dt(C){Rt.equals(C)===!1&&(i.scissor(C.x,C.y,C.z,C.w),Rt.copy(C))}function xt(C){X.equals(C)===!1&&(i.viewport(C.x,C.y,C.z,C.w),X.copy(C))}function kt(C,ft){let q=l.get(ft);q===void 0&&(q=new WeakMap,l.set(ft,q));let Q=q.get(C);Q===void 0&&(Q=i.getUniformBlockIndex(ft,C.name),q.set(C,Q))}function It(C,ft){const Q=l.get(ft).get(C);c.get(ft)!==Q&&(i.uniformBlockBinding(ft,Q,C.__bindingPointIndex),c.set(ft,Q))}function Yt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),h={},et=null,it={},d={},f=new WeakMap,m=[],v=null,x=!1,p=null,u=null,T=null,A=null,_=null,B=null,b=null,w=new Vt(0,0,0),P=0,y=!1,M=null,R=null,z=null,L=null,G=null,Rt.set(0,0,i.canvas.width,i.canvas.height),X.set(0,0,i.canvas.width,i.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:ht,disable:Lt,bindFramebuffer:Nt,drawBuffers:Ht,useProgram:ee,setBlending:N,setMaterial:O,setFlipSided:dt,setCullFace:ot,setLineWidth:lt,setPolygonOffset:Ct,setScissorTest:gt,activeTexture:E,bindTexture:g,unbindTexture:F,compressedTexImage2D:Z,compressedTexImage3D:$,texImage2D:St,texImage3D:Pt,updateUBOMapping:kt,uniformBlockBinding:It,texStorage2D:Ut,texStorage3D:rt,texSubImage2D:Y,texSubImage3D:Mt,compressedTexSubImage2D:at,compressedTexSubImage3D:ct,scissor:Dt,viewport:xt,reset:Yt}}function lo(i,t,e,n){const r=rp(n);switch(e){case To:return i*t;case bo:return i*t;case wo:return i*t*2;case qs:return i*t/r.components*r.byteLength;case Ys:return i*t/r.components*r.byteLength;case Ro:return i*t*2/r.components*r.byteLength;case Ks:return i*t*2/r.components*r.byteLength;case Ao:return i*t*3/r.components*r.byteLength;case Ge:return i*t*4/r.components*r.byteLength;case Zs:return i*t*4/r.components*r.byteLength;case ur:case hr:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*8;case dr:case fr:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*16;case ps:case gs:return Math.max(i,16)*Math.max(t,8)/4;case fs:case ms:return Math.max(i,8)*Math.max(t,8)/2;case _s:case vs:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*8;case xs:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*16;case Ms:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*16;case Ss:return Math.floor((i+4)/5)*Math.floor((t+3)/4)*16;case ys:return Math.floor((i+4)/5)*Math.floor((t+4)/5)*16;case Es:return Math.floor((i+5)/6)*Math.floor((t+4)/5)*16;case Ts:return Math.floor((i+5)/6)*Math.floor((t+5)/6)*16;case As:return Math.floor((i+7)/8)*Math.floor((t+4)/5)*16;case bs:return Math.floor((i+7)/8)*Math.floor((t+5)/6)*16;case ws:return Math.floor((i+7)/8)*Math.floor((t+7)/8)*16;case Rs:return Math.floor((i+9)/10)*Math.floor((t+4)/5)*16;case Cs:return Math.floor((i+9)/10)*Math.floor((t+5)/6)*16;case Ps:return Math.floor((i+9)/10)*Math.floor((t+7)/8)*16;case Ls:return Math.floor((i+9)/10)*Math.floor((t+9)/10)*16;case Ds:return Math.floor((i+11)/12)*Math.floor((t+9)/10)*16;case Is:return Math.floor((i+11)/12)*Math.floor((t+11)/12)*16;case pr:case Us:case Ns:return Math.ceil(i/4)*Math.ceil(t/4)*16;case Co:case Fs:return Math.ceil(i/4)*Math.ceil(t/4)*8;case Os:case Bs:return Math.ceil(i/4)*Math.ceil(t/4)*16}throw new Error(`Unable to determine texture byte length for ${e} format.`)}function rp(i){switch(i){case ln:case So:return{byteLength:1,components:1};case Di:case yo:case Fi:return{byteLength:2,components:1};case Ws:case Xs:return{byteLength:2,components:4};case On:case Gs:case $e:return{byteLength:4,components:1};case Eo:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${i}.`)}function sp(i,t,e,n,r,s,a){const o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new qt,h=new WeakMap;let d;const f=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function v(E,g){return m?new OffscreenCanvas(E,g):_r("canvas")}function x(E,g,F){let Z=1;const $=gt(E);if(($.width>F||$.height>F)&&(Z=F/Math.max($.width,$.height)),Z<1)if(typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&E instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&E instanceof ImageBitmap||typeof VideoFrame<"u"&&E instanceof VideoFrame){const Y=Math.floor(Z*$.width),Mt=Math.floor(Z*$.height);d===void 0&&(d=v(Y,Mt));const at=g?v(Y,Mt):d;return at.width=Y,at.height=Mt,at.getContext("2d").drawImage(E,0,0,Y,Mt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+$.width+"x"+$.height+") to ("+Y+"x"+Mt+")."),at}else return"data"in E&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+$.width+"x"+$.height+")."),E;return E}function p(E){return E.generateMipmaps}function u(E){i.generateMipmap(E)}function T(E){return E.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:E.isWebGL3DRenderTarget?i.TEXTURE_3D:E.isWebGLArrayRenderTarget||E.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function A(E,g,F,Z,$=!1){if(E!==null){if(i[E]!==void 0)return i[E];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+E+"'")}let Y=g;if(g===i.RED&&(F===i.FLOAT&&(Y=i.R32F),F===i.HALF_FLOAT&&(Y=i.R16F),F===i.UNSIGNED_BYTE&&(Y=i.R8)),g===i.RED_INTEGER&&(F===i.UNSIGNED_BYTE&&(Y=i.R8UI),F===i.UNSIGNED_SHORT&&(Y=i.R16UI),F===i.UNSIGNED_INT&&(Y=i.R32UI),F===i.BYTE&&(Y=i.R8I),F===i.SHORT&&(Y=i.R16I),F===i.INT&&(Y=i.R32I)),g===i.RG&&(F===i.FLOAT&&(Y=i.RG32F),F===i.HALF_FLOAT&&(Y=i.RG16F),F===i.UNSIGNED_BYTE&&(Y=i.RG8)),g===i.RG_INTEGER&&(F===i.UNSIGNED_BYTE&&(Y=i.RG8UI),F===i.UNSIGNED_SHORT&&(Y=i.RG16UI),F===i.UNSIGNED_INT&&(Y=i.RG32UI),F===i.BYTE&&(Y=i.RG8I),F===i.SHORT&&(Y=i.RG16I),F===i.INT&&(Y=i.RG32I)),g===i.RGB_INTEGER&&(F===i.UNSIGNED_BYTE&&(Y=i.RGB8UI),F===i.UNSIGNED_SHORT&&(Y=i.RGB16UI),F===i.UNSIGNED_INT&&(Y=i.RGB32UI),F===i.BYTE&&(Y=i.RGB8I),F===i.SHORT&&(Y=i.RGB16I),F===i.INT&&(Y=i.RGB32I)),g===i.RGBA_INTEGER&&(F===i.UNSIGNED_BYTE&&(Y=i.RGBA8UI),F===i.UNSIGNED_SHORT&&(Y=i.RGBA16UI),F===i.UNSIGNED_INT&&(Y=i.RGBA32UI),F===i.BYTE&&(Y=i.RGBA8I),F===i.SHORT&&(Y=i.RGBA16I),F===i.INT&&(Y=i.RGBA32I)),g===i.RGB&&F===i.UNSIGNED_INT_5_9_9_9_REV&&(Y=i.RGB9_E5),g===i.RGBA){const Mt=$?xr:Xt.getTransfer(Z);F===i.FLOAT&&(Y=i.RGBA32F),F===i.HALF_FLOAT&&(Y=i.RGBA16F),F===i.UNSIGNED_BYTE&&(Y=Mt===jt?i.SRGB8_ALPHA8:i.RGBA8),F===i.UNSIGNED_SHORT_4_4_4_4&&(Y=i.RGBA4),F===i.UNSIGNED_SHORT_5_5_5_1&&(Y=i.RGB5_A1)}return(Y===i.R16F||Y===i.R32F||Y===i.RG16F||Y===i.RG32F||Y===i.RGBA16F||Y===i.RGBA32F)&&t.get("EXT_color_buffer_float"),Y}function _(E,g){let F;return E?g===null||g===On||g===ui?F=i.DEPTH24_STENCIL8:g===$e?F=i.DEPTH32F_STENCIL8:g===Di&&(F=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===On||g===ui?F=i.DEPTH_COMPONENT24:g===$e?F=i.DEPTH_COMPONENT32F:g===Di&&(F=i.DEPTH_COMPONENT16),F}function B(E,g){return p(E)===!0||E.isFramebufferTexture&&E.minFilter!==Ce&&E.minFilter!==Ze?Math.log2(Math.max(g.width,g.height))+1:E.mipmaps!==void 0&&E.mipmaps.length>0?E.mipmaps.length:E.isCompressedTexture&&Array.isArray(E.image)?g.mipmaps.length:1}function b(E){const g=E.target;g.removeEventListener("dispose",b),P(g),g.isVideoTexture&&h.delete(g)}function w(E){const g=E.target;g.removeEventListener("dispose",w),M(g)}function P(E){const g=n.get(E);if(g.__webglInit===void 0)return;const F=E.source,Z=f.get(F);if(Z){const $=Z[g.__cacheKey];$.usedTimes--,$.usedTimes===0&&y(E),Object.keys(Z).length===0&&f.delete(F)}n.remove(E)}function y(E){const g=n.get(E);i.deleteTexture(g.__webglTexture);const F=E.source,Z=f.get(F);delete Z[g.__cacheKey],a.memory.textures--}function M(E){const g=n.get(E);if(E.depthTexture&&(E.depthTexture.dispose(),n.remove(E.depthTexture)),E.isWebGLCubeRenderTarget)for(let Z=0;Z<6;Z++){if(Array.isArray(g.__webglFramebuffer[Z]))for(let $=0;$<g.__webglFramebuffer[Z].length;$++)i.deleteFramebuffer(g.__webglFramebuffer[Z][$]);else i.deleteFramebuffer(g.__webglFramebuffer[Z]);g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer[Z])}else{if(Array.isArray(g.__webglFramebuffer))for(let Z=0;Z<g.__webglFramebuffer.length;Z++)i.deleteFramebuffer(g.__webglFramebuffer[Z]);else i.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&i.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let Z=0;Z<g.__webglColorRenderbuffer.length;Z++)g.__webglColorRenderbuffer[Z]&&i.deleteRenderbuffer(g.__webglColorRenderbuffer[Z]);g.__webglDepthRenderbuffer&&i.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const F=E.textures;for(let Z=0,$=F.length;Z<$;Z++){const Y=n.get(F[Z]);Y.__webglTexture&&(i.deleteTexture(Y.__webglTexture),a.memory.textures--),n.remove(F[Z])}n.remove(E)}let R=0;function z(){R=0}function L(){const E=R;return E>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+E+" texture units while this GPU supports only "+r.maxTextures),R+=1,E}function G(E){const g=[];return g.push(E.wrapS),g.push(E.wrapT),g.push(E.wrapR||0),g.push(E.magFilter),g.push(E.minFilter),g.push(E.anisotropy),g.push(E.internalFormat),g.push(E.format),g.push(E.type),g.push(E.generateMipmaps),g.push(E.premultiplyAlpha),g.push(E.flipY),g.push(E.unpackAlignment),g.push(E.colorSpace),g.join()}function K(E,g){const F=n.get(E);if(E.isVideoTexture&&lt(E),E.isRenderTargetTexture===!1&&E.version>0&&F.__version!==E.version){const Z=E.image;if(Z===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Z.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{X(F,E,g);return}}e.bindTexture(i.TEXTURE_2D,F.__webglTexture,i.TEXTURE0+g)}function W(E,g){const F=n.get(E);if(E.version>0&&F.__version!==E.version){X(F,E,g);return}e.bindTexture(i.TEXTURE_2D_ARRAY,F.__webglTexture,i.TEXTURE0+g)}function tt(E,g){const F=n.get(E);if(E.version>0&&F.__version!==E.version){X(F,E,g);return}e.bindTexture(i.TEXTURE_3D,F.__webglTexture,i.TEXTURE0+g)}function D(E,g){const F=n.get(E);if(E.version>0&&F.__version!==E.version){J(F,E,g);return}e.bindTexture(i.TEXTURE_CUBE_MAP,F.__webglTexture,i.TEXTURE0+g)}const et={[hs]:i.REPEAT,[Nn]:i.CLAMP_TO_EDGE,[ds]:i.MIRRORED_REPEAT},it={[Ce]:i.NEAREST,[Cc]:i.NEAREST_MIPMAP_NEAREST,[Vi]:i.NEAREST_MIPMAP_LINEAR,[Ze]:i.LINEAR,[Tr]:i.LINEAR_MIPMAP_NEAREST,[Fn]:i.LINEAR_MIPMAP_LINEAR},ut={[Ic]:i.NEVER,[zc]:i.ALWAYS,[Uc]:i.LESS,[Lo]:i.LEQUAL,[Nc]:i.EQUAL,[Bc]:i.GEQUAL,[Fc]:i.GREATER,[Oc]:i.NOTEQUAL};function vt(E,g){if(g.type===$e&&t.has("OES_texture_float_linear")===!1&&(g.magFilter===Ze||g.magFilter===Tr||g.magFilter===Vi||g.magFilter===Fn||g.minFilter===Ze||g.minFilter===Tr||g.minFilter===Vi||g.minFilter===Fn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(E,i.TEXTURE_WRAP_S,et[g.wrapS]),i.texParameteri(E,i.TEXTURE_WRAP_T,et[g.wrapT]),(E===i.TEXTURE_3D||E===i.TEXTURE_2D_ARRAY)&&i.texParameteri(E,i.TEXTURE_WRAP_R,et[g.wrapR]),i.texParameteri(E,i.TEXTURE_MAG_FILTER,it[g.magFilter]),i.texParameteri(E,i.TEXTURE_MIN_FILTER,it[g.minFilter]),g.compareFunction&&(i.texParameteri(E,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(E,i.TEXTURE_COMPARE_FUNC,ut[g.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===Ce||g.minFilter!==Vi&&g.minFilter!==Fn||g.type===$e&&t.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||n.get(g).__currentAnisotropy){const F=t.get("EXT_texture_filter_anisotropic");i.texParameterf(E,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,r.getMaxAnisotropy())),n.get(g).__currentAnisotropy=g.anisotropy}}}function Rt(E,g){let F=!1;E.__webglInit===void 0&&(E.__webglInit=!0,g.addEventListener("dispose",b));const Z=g.source;let $=f.get(Z);$===void 0&&($={},f.set(Z,$));const Y=G(g);if(Y!==E.__cacheKey){$[Y]===void 0&&($[Y]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,F=!0),$[Y].usedTimes++;const Mt=$[E.__cacheKey];Mt!==void 0&&($[E.__cacheKey].usedTimes--,Mt.usedTimes===0&&y(g)),E.__cacheKey=Y,E.__webglTexture=$[Y].texture}return F}function X(E,g,F){let Z=i.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(Z=i.TEXTURE_2D_ARRAY),g.isData3DTexture&&(Z=i.TEXTURE_3D);const $=Rt(E,g),Y=g.source;e.bindTexture(Z,E.__webglTexture,i.TEXTURE0+F);const Mt=n.get(Y);if(Y.version!==Mt.__version||$===!0){e.activeTexture(i.TEXTURE0+F);const at=Xt.getPrimaries(Xt.workingColorSpace),ct=g.colorSpace===vn?null:Xt.getPrimaries(g.colorSpace),Ut=g.colorSpace===vn||at===ct?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ut);let rt=x(g.image,!1,r.maxTextureSize);rt=Ct(g,rt);const St=s.convert(g.format,g.colorSpace),Pt=s.convert(g.type);let Dt=A(g.internalFormat,St,Pt,g.colorSpace,g.isVideoTexture);vt(Z,g);let xt;const kt=g.mipmaps,It=g.isVideoTexture!==!0,Yt=Mt.__version===void 0||$===!0,C=Y.dataReady,ft=B(g,rt);if(g.isDepthTexture)Dt=_(g.format===hi,g.type),Yt&&(It?e.texStorage2D(i.TEXTURE_2D,1,Dt,rt.width,rt.height):e.texImage2D(i.TEXTURE_2D,0,Dt,rt.width,rt.height,0,St,Pt,null));else if(g.isDataTexture)if(kt.length>0){It&&Yt&&e.texStorage2D(i.TEXTURE_2D,ft,Dt,kt[0].width,kt[0].height);for(let q=0,Q=kt.length;q<Q;q++)xt=kt[q],It?C&&e.texSubImage2D(i.TEXTURE_2D,q,0,0,xt.width,xt.height,St,Pt,xt.data):e.texImage2D(i.TEXTURE_2D,q,Dt,xt.width,xt.height,0,St,Pt,xt.data);g.generateMipmaps=!1}else It?(Yt&&e.texStorage2D(i.TEXTURE_2D,ft,Dt,rt.width,rt.height),C&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,rt.width,rt.height,St,Pt,rt.data)):e.texImage2D(i.TEXTURE_2D,0,Dt,rt.width,rt.height,0,St,Pt,rt.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){It&&Yt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,ft,Dt,kt[0].width,kt[0].height,rt.depth);for(let q=0,Q=kt.length;q<Q;q++)if(xt=kt[q],g.format!==Ge)if(St!==null)if(It){if(C)if(g.layerUpdates.size>0){const mt=lo(xt.width,xt.height,g.format,g.type);for(const nt of g.layerUpdates){const yt=xt.data.subarray(nt*mt/xt.data.BYTES_PER_ELEMENT,(nt+1)*mt/xt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,q,0,0,nt,xt.width,xt.height,1,St,yt)}g.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,q,0,0,0,xt.width,xt.height,rt.depth,St,xt.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,q,Dt,xt.width,xt.height,rt.depth,0,xt.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else It?C&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,q,0,0,0,xt.width,xt.height,rt.depth,St,Pt,xt.data):e.texImage3D(i.TEXTURE_2D_ARRAY,q,Dt,xt.width,xt.height,rt.depth,0,St,Pt,xt.data)}else{It&&Yt&&e.texStorage2D(i.TEXTURE_2D,ft,Dt,kt[0].width,kt[0].height);for(let q=0,Q=kt.length;q<Q;q++)xt=kt[q],g.format!==Ge?St!==null?It?C&&e.compressedTexSubImage2D(i.TEXTURE_2D,q,0,0,xt.width,xt.height,St,xt.data):e.compressedTexImage2D(i.TEXTURE_2D,q,Dt,xt.width,xt.height,0,xt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):It?C&&e.texSubImage2D(i.TEXTURE_2D,q,0,0,xt.width,xt.height,St,Pt,xt.data):e.texImage2D(i.TEXTURE_2D,q,Dt,xt.width,xt.height,0,St,Pt,xt.data)}else if(g.isDataArrayTexture)if(It){if(Yt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,ft,Dt,rt.width,rt.height,rt.depth),C)if(g.layerUpdates.size>0){const q=lo(rt.width,rt.height,g.format,g.type);for(const Q of g.layerUpdates){const mt=rt.data.subarray(Q*q/rt.data.BYTES_PER_ELEMENT,(Q+1)*q/rt.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,Q,rt.width,rt.height,1,St,Pt,mt)}g.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,rt.width,rt.height,rt.depth,St,Pt,rt.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,Dt,rt.width,rt.height,rt.depth,0,St,Pt,rt.data);else if(g.isData3DTexture)It?(Yt&&e.texStorage3D(i.TEXTURE_3D,ft,Dt,rt.width,rt.height,rt.depth),C&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,rt.width,rt.height,rt.depth,St,Pt,rt.data)):e.texImage3D(i.TEXTURE_3D,0,Dt,rt.width,rt.height,rt.depth,0,St,Pt,rt.data);else if(g.isFramebufferTexture){if(Yt)if(It)e.texStorage2D(i.TEXTURE_2D,ft,Dt,rt.width,rt.height);else{let q=rt.width,Q=rt.height;for(let mt=0;mt<ft;mt++)e.texImage2D(i.TEXTURE_2D,mt,Dt,q,Q,0,St,Pt,null),q>>=1,Q>>=1}}else if(kt.length>0){if(It&&Yt){const q=gt(kt[0]);e.texStorage2D(i.TEXTURE_2D,ft,Dt,q.width,q.height)}for(let q=0,Q=kt.length;q<Q;q++)xt=kt[q],It?C&&e.texSubImage2D(i.TEXTURE_2D,q,0,0,St,Pt,xt):e.texImage2D(i.TEXTURE_2D,q,Dt,St,Pt,xt);g.generateMipmaps=!1}else if(It){if(Yt){const q=gt(rt);e.texStorage2D(i.TEXTURE_2D,ft,Dt,q.width,q.height)}C&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,St,Pt,rt)}else e.texImage2D(i.TEXTURE_2D,0,Dt,St,Pt,rt);p(g)&&u(Z),Mt.__version=Y.version,g.onUpdate&&g.onUpdate(g)}E.__version=g.version}function J(E,g,F){if(g.image.length!==6)return;const Z=Rt(E,g),$=g.source;e.bindTexture(i.TEXTURE_CUBE_MAP,E.__webglTexture,i.TEXTURE0+F);const Y=n.get($);if($.version!==Y.__version||Z===!0){e.activeTexture(i.TEXTURE0+F);const Mt=Xt.getPrimaries(Xt.workingColorSpace),at=g.colorSpace===vn?null:Xt.getPrimaries(g.colorSpace),ct=g.colorSpace===vn||Mt===at?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ct);const Ut=g.isCompressedTexture||g.image[0].isCompressedTexture,rt=g.image[0]&&g.image[0].isDataTexture,St=[];for(let Q=0;Q<6;Q++)!Ut&&!rt?St[Q]=x(g.image[Q],!0,r.maxCubemapSize):St[Q]=rt?g.image[Q].image:g.image[Q],St[Q]=Ct(g,St[Q]);const Pt=St[0],Dt=s.convert(g.format,g.colorSpace),xt=s.convert(g.type),kt=A(g.internalFormat,Dt,xt,g.colorSpace),It=g.isVideoTexture!==!0,Yt=Y.__version===void 0||Z===!0,C=$.dataReady;let ft=B(g,Pt);vt(i.TEXTURE_CUBE_MAP,g);let q;if(Ut){It&&Yt&&e.texStorage2D(i.TEXTURE_CUBE_MAP,ft,kt,Pt.width,Pt.height);for(let Q=0;Q<6;Q++){q=St[Q].mipmaps;for(let mt=0;mt<q.length;mt++){const nt=q[mt];g.format!==Ge?Dt!==null?It?C&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,mt,0,0,nt.width,nt.height,Dt,nt.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,mt,kt,nt.width,nt.height,0,nt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):It?C&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,mt,0,0,nt.width,nt.height,Dt,xt,nt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,mt,kt,nt.width,nt.height,0,Dt,xt,nt.data)}}}else{if(q=g.mipmaps,It&&Yt){q.length>0&&ft++;const Q=gt(St[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,ft,kt,Q.width,Q.height)}for(let Q=0;Q<6;Q++)if(rt){It?C&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,St[Q].width,St[Q].height,Dt,xt,St[Q].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,kt,St[Q].width,St[Q].height,0,Dt,xt,St[Q].data);for(let mt=0;mt<q.length;mt++){const yt=q[mt].image[Q].image;It?C&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,mt+1,0,0,yt.width,yt.height,Dt,xt,yt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,mt+1,kt,yt.width,yt.height,0,Dt,xt,yt.data)}}else{It?C&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,Dt,xt,St[Q]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,kt,Dt,xt,St[Q]);for(let mt=0;mt<q.length;mt++){const nt=q[mt];It?C&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,mt+1,0,0,Dt,xt,nt.image[Q]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,mt+1,kt,Dt,xt,nt.image[Q])}}}p(g)&&u(i.TEXTURE_CUBE_MAP),Y.__version=$.version,g.onUpdate&&g.onUpdate(g)}E.__version=g.version}function Et(E,g,F,Z,$,Y){const Mt=s.convert(F.format,F.colorSpace),at=s.convert(F.type),ct=A(F.internalFormat,Mt,at,F.colorSpace),Ut=n.get(g),rt=n.get(F);if(rt.__renderTarget=g,!Ut.__hasExternalTextures){const St=Math.max(1,g.width>>Y),Pt=Math.max(1,g.height>>Y);$===i.TEXTURE_3D||$===i.TEXTURE_2D_ARRAY?e.texImage3D($,Y,ct,St,Pt,g.depth,0,Mt,at,null):e.texImage2D($,Y,ct,St,Pt,0,Mt,at,null)}e.bindFramebuffer(i.FRAMEBUFFER,E),ot(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Z,$,rt.__webglTexture,0,dt(g)):($===i.TEXTURE_2D||$>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&$<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,Z,$,rt.__webglTexture,Y),e.bindFramebuffer(i.FRAMEBUFFER,null)}function ht(E,g,F){if(i.bindRenderbuffer(i.RENDERBUFFER,E),g.depthBuffer){const Z=g.depthTexture,$=Z&&Z.isDepthTexture?Z.type:null,Y=_(g.stencilBuffer,$),Mt=g.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,at=dt(g);ot(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,at,Y,g.width,g.height):F?i.renderbufferStorageMultisample(i.RENDERBUFFER,at,Y,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,Y,g.width,g.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Mt,i.RENDERBUFFER,E)}else{const Z=g.textures;for(let $=0;$<Z.length;$++){const Y=Z[$],Mt=s.convert(Y.format,Y.colorSpace),at=s.convert(Y.type),ct=A(Y.internalFormat,Mt,at,Y.colorSpace),Ut=dt(g);F&&ot(g)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Ut,ct,g.width,g.height):ot(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Ut,ct,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,ct,g.width,g.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Lt(E,g){if(g&&g.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(i.FRAMEBUFFER,E),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Z=n.get(g.depthTexture);Z.__renderTarget=g,(!Z.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),K(g.depthTexture,0);const $=Z.__webglTexture,Y=dt(g);if(g.depthTexture.format===si)ot(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,$,0,Y):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,$,0);else if(g.depthTexture.format===hi)ot(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,$,0,Y):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,$,0);else throw new Error("Unknown depthTexture format")}function Nt(E){const g=n.get(E),F=E.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==E.depthTexture){const Z=E.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),Z){const $=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,Z.removeEventListener("dispose",$)};Z.addEventListener("dispose",$),g.__depthDisposeCallback=$}g.__boundDepthTexture=Z}if(E.depthTexture&&!g.__autoAllocateDepthBuffer){if(F)throw new Error("target.depthTexture not supported in Cube render targets");Lt(g.__webglFramebuffer,E)}else if(F){g.__webglDepthbuffer=[];for(let Z=0;Z<6;Z++)if(e.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[Z]),g.__webglDepthbuffer[Z]===void 0)g.__webglDepthbuffer[Z]=i.createRenderbuffer(),ht(g.__webglDepthbuffer[Z],E,!1);else{const $=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Y=g.__webglDepthbuffer[Z];i.bindRenderbuffer(i.RENDERBUFFER,Y),i.framebufferRenderbuffer(i.FRAMEBUFFER,$,i.RENDERBUFFER,Y)}}else if(e.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=i.createRenderbuffer(),ht(g.__webglDepthbuffer,E,!1);else{const Z=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,$=g.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,$),i.framebufferRenderbuffer(i.FRAMEBUFFER,Z,i.RENDERBUFFER,$)}e.bindFramebuffer(i.FRAMEBUFFER,null)}function Ht(E,g,F){const Z=n.get(E);g!==void 0&&Et(Z.__webglFramebuffer,E,E.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),F!==void 0&&Nt(E)}function ee(E){const g=E.texture,F=n.get(E),Z=n.get(g);E.addEventListener("dispose",w);const $=E.textures,Y=E.isWebGLCubeRenderTarget===!0,Mt=$.length>1;if(Mt||(Z.__webglTexture===void 0&&(Z.__webglTexture=i.createTexture()),Z.__version=g.version,a.memory.textures++),Y){F.__webglFramebuffer=[];for(let at=0;at<6;at++)if(g.mipmaps&&g.mipmaps.length>0){F.__webglFramebuffer[at]=[];for(let ct=0;ct<g.mipmaps.length;ct++)F.__webglFramebuffer[at][ct]=i.createFramebuffer()}else F.__webglFramebuffer[at]=i.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){F.__webglFramebuffer=[];for(let at=0;at<g.mipmaps.length;at++)F.__webglFramebuffer[at]=i.createFramebuffer()}else F.__webglFramebuffer=i.createFramebuffer();if(Mt)for(let at=0,ct=$.length;at<ct;at++){const Ut=n.get($[at]);Ut.__webglTexture===void 0&&(Ut.__webglTexture=i.createTexture(),a.memory.textures++)}if(E.samples>0&&ot(E)===!1){F.__webglMultisampledFramebuffer=i.createFramebuffer(),F.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let at=0;at<$.length;at++){const ct=$[at];F.__webglColorRenderbuffer[at]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,F.__webglColorRenderbuffer[at]);const Ut=s.convert(ct.format,ct.colorSpace),rt=s.convert(ct.type),St=A(ct.internalFormat,Ut,rt,ct.colorSpace,E.isXRRenderTarget===!0),Pt=dt(E);i.renderbufferStorageMultisample(i.RENDERBUFFER,Pt,St,E.width,E.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+at,i.RENDERBUFFER,F.__webglColorRenderbuffer[at])}i.bindRenderbuffer(i.RENDERBUFFER,null),E.depthBuffer&&(F.__webglDepthRenderbuffer=i.createRenderbuffer(),ht(F.__webglDepthRenderbuffer,E,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(Y){e.bindTexture(i.TEXTURE_CUBE_MAP,Z.__webglTexture),vt(i.TEXTURE_CUBE_MAP,g);for(let at=0;at<6;at++)if(g.mipmaps&&g.mipmaps.length>0)for(let ct=0;ct<g.mipmaps.length;ct++)Et(F.__webglFramebuffer[at][ct],E,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+at,ct);else Et(F.__webglFramebuffer[at],E,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+at,0);p(g)&&u(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(Mt){for(let at=0,ct=$.length;at<ct;at++){const Ut=$[at],rt=n.get(Ut);e.bindTexture(i.TEXTURE_2D,rt.__webglTexture),vt(i.TEXTURE_2D,Ut),Et(F.__webglFramebuffer,E,Ut,i.COLOR_ATTACHMENT0+at,i.TEXTURE_2D,0),p(Ut)&&u(i.TEXTURE_2D)}e.unbindTexture()}else{let at=i.TEXTURE_2D;if((E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(at=E.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(at,Z.__webglTexture),vt(at,g),g.mipmaps&&g.mipmaps.length>0)for(let ct=0;ct<g.mipmaps.length;ct++)Et(F.__webglFramebuffer[ct],E,g,i.COLOR_ATTACHMENT0,at,ct);else Et(F.__webglFramebuffer,E,g,i.COLOR_ATTACHMENT0,at,0);p(g)&&u(at),e.unbindTexture()}E.depthBuffer&&Nt(E)}function Gt(E){const g=E.textures;for(let F=0,Z=g.length;F<Z;F++){const $=g[F];if(p($)){const Y=T(E),Mt=n.get($).__webglTexture;e.bindTexture(Y,Mt),u(Y),e.unbindTexture()}}}const se=[],N=[];function O(E){if(E.samples>0){if(ot(E)===!1){const g=E.textures,F=E.width,Z=E.height;let $=i.COLOR_BUFFER_BIT;const Y=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Mt=n.get(E),at=g.length>1;if(at)for(let ct=0;ct<g.length;ct++)e.bindFramebuffer(i.FRAMEBUFFER,Mt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ct,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,Mt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ct,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,Mt.__webglMultisampledFramebuffer),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,Mt.__webglFramebuffer);for(let ct=0;ct<g.length;ct++){if(E.resolveDepthBuffer&&(E.depthBuffer&&($|=i.DEPTH_BUFFER_BIT),E.stencilBuffer&&E.resolveStencilBuffer&&($|=i.STENCIL_BUFFER_BIT)),at){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Mt.__webglColorRenderbuffer[ct]);const Ut=n.get(g[ct]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Ut,0)}i.blitFramebuffer(0,0,F,Z,0,0,F,Z,$,i.NEAREST),c===!0&&(se.length=0,N.length=0,se.push(i.COLOR_ATTACHMENT0+ct),E.depthBuffer&&E.resolveDepthBuffer===!1&&(se.push(Y),N.push(Y),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,N)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,se))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),at)for(let ct=0;ct<g.length;ct++){e.bindFramebuffer(i.FRAMEBUFFER,Mt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ct,i.RENDERBUFFER,Mt.__webglColorRenderbuffer[ct]);const Ut=n.get(g[ct]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,Mt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ct,i.TEXTURE_2D,Ut,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,Mt.__webglMultisampledFramebuffer)}else if(E.depthBuffer&&E.resolveDepthBuffer===!1&&c){const g=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[g])}}}function dt(E){return Math.min(r.maxSamples,E.samples)}function ot(E){const g=n.get(E);return E.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function lt(E){const g=a.render.frame;h.get(E)!==g&&(h.set(E,g),E.update())}function Ct(E,g){const F=E.colorSpace,Z=E.format,$=E.type;return E.isCompressedTexture===!0||E.isVideoTexture===!0||F!==fi&&F!==vn&&(Xt.getTransfer(F)===jt?(Z!==Ge||$!==ln)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",F)),g}function gt(E){return typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement?(l.width=E.naturalWidth||E.width,l.height=E.naturalHeight||E.height):typeof VideoFrame<"u"&&E instanceof VideoFrame?(l.width=E.displayWidth,l.height=E.displayHeight):(l.width=E.width,l.height=E.height),l}this.allocateTextureUnit=L,this.resetTextureUnits=z,this.setTexture2D=K,this.setTexture2DArray=W,this.setTexture3D=tt,this.setTextureCube=D,this.rebindTextures=Ht,this.setupRenderTarget=ee,this.updateRenderTargetMipmap=Gt,this.updateMultisampleRenderTarget=O,this.setupDepthRenderbuffer=Nt,this.setupFrameBufferTexture=Et,this.useMultisampledRTT=ot}function ap(i,t){function e(n,r=vn){let s;const a=Xt.getTransfer(r);if(n===ln)return i.UNSIGNED_BYTE;if(n===Ws)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Xs)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Eo)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===So)return i.BYTE;if(n===yo)return i.SHORT;if(n===Di)return i.UNSIGNED_SHORT;if(n===Gs)return i.INT;if(n===On)return i.UNSIGNED_INT;if(n===$e)return i.FLOAT;if(n===Fi)return i.HALF_FLOAT;if(n===To)return i.ALPHA;if(n===Ao)return i.RGB;if(n===Ge)return i.RGBA;if(n===bo)return i.LUMINANCE;if(n===wo)return i.LUMINANCE_ALPHA;if(n===si)return i.DEPTH_COMPONENT;if(n===hi)return i.DEPTH_STENCIL;if(n===qs)return i.RED;if(n===Ys)return i.RED_INTEGER;if(n===Ro)return i.RG;if(n===Ks)return i.RG_INTEGER;if(n===Zs)return i.RGBA_INTEGER;if(n===ur||n===hr||n===dr||n===fr)if(a===jt)if(s=t.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===ur)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===hr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===dr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===fr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=t.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===ur)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===hr)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===dr)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===fr)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===fs||n===ps||n===ms||n===gs)if(s=t.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===fs)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===ps)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===ms)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===gs)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===_s||n===vs||n===xs)if(s=t.get("WEBGL_compressed_texture_etc"),s!==null){if(n===_s||n===vs)return a===jt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===xs)return a===jt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Ms||n===Ss||n===ys||n===Es||n===Ts||n===As||n===bs||n===ws||n===Rs||n===Cs||n===Ps||n===Ls||n===Ds||n===Is)if(s=t.get("WEBGL_compressed_texture_astc"),s!==null){if(n===Ms)return a===jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ss)return a===jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===ys)return a===jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Es)return a===jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Ts)return a===jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===As)return a===jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===bs)return a===jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===ws)return a===jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Rs)return a===jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Cs)return a===jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Ps)return a===jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Ls)return a===jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Ds)return a===jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Is)return a===jt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===pr||n===Us||n===Ns)if(s=t.get("EXT_texture_compression_bptc"),s!==null){if(n===pr)return a===jt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Us)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Ns)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Co||n===Fs||n===Os||n===Bs)if(s=t.get("EXT_texture_compression_rgtc"),s!==null){if(n===pr)return s.COMPRESSED_RED_RGTC1_EXT;if(n===Fs)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Os)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Bs)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===ui?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}class op extends Ue{constructor(t=[]){super(),this.isArrayCamera=!0,this.cameras=t}}class Xe extends pe{constructor(){super(),this.isGroup=!0,this.type="Group"}}const cp={type:"move"};class jr{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Xe,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Xe,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new H,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new H),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Xe,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new H,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new H),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const n of t.hand.values())this._getHandJoint(e,n)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,n){let r=null,s=null,a=null;const o=this._targetRay,c=this._grip,l=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(l&&t.hand){a=!0;for(const x of t.hand.values()){const p=e.getJointPose(x,n),u=this._getHandJoint(l,x);p!==null&&(u.matrix.fromArray(p.transform.matrix),u.matrix.decompose(u.position,u.rotation,u.scale),u.matrixWorldNeedsUpdate=!0,u.jointRadius=p.radius),u.visible=p!==null}const h=l.joints["index-finger-tip"],d=l.joints["thumb-tip"],f=h.position.distanceTo(d.position),m=.02,v=.005;l.inputState.pinching&&f>m+v?(l.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!l.inputState.pinching&&f<=m-v&&(l.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else c!==null&&t.gripSpace&&(s=e.getPose(t.gripSpace,n),s!==null&&(c.matrix.fromArray(s.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,s.linearVelocity?(c.hasLinearVelocity=!0,c.linearVelocity.copy(s.linearVelocity)):c.hasLinearVelocity=!1,s.angularVelocity?(c.hasAngularVelocity=!0,c.angularVelocity.copy(s.angularVelocity)):c.hasAngularVelocity=!1));o!==null&&(r=e.getPose(t.targetRaySpace,n),r===null&&s!==null&&(r=s),r!==null&&(o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,r.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(r.linearVelocity)):o.hasLinearVelocity=!1,r.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(r.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(cp)))}return o!==null&&(o.visible=r!==null),c!==null&&(c.visible=s!==null),l!==null&&(l.visible=a!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const n=new Xe;n.matrixAutoUpdate=!1,n.visible=!1,t.joints[e.jointName]=n,t.add(n)}return t.joints[e.jointName]}}const lp=`
void main() {
...
}`;class hp{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e,n){if(this.texture===null){const r=new Me,s=t.properties.get(r);s.__webglTexture=e.texture,(e.depthNear!=n.depthNear||e.depthFar!=n.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=r}}getMesh(t){if(this.texture!==null&&this.mesh===null){const e=t.cameras[0].viewport,n=new yn({vertexShader:lp,fragmentShader:up,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new te(new Mr(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class dp extends pi{constructor(t,e){super();const n=this;let r=null,s=1,a=null,o="local-floor",c=1,l=null,h=null,d=null,f=null,m=null,v=null;const x=new hp,p=e.getContextAttributes();let u=null,T=null;const A=[],_=[],B=new qt;let b=null;const w=new Ue;w.viewport=new ae;const P=new Ue;P.viewport=new ae;const y=[w,P],M=new op;let R=null,z=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(X){let J=A[X];return J===void 0&&(J=new jr,A[X]=J),J.getTargetRaySpace()},this.getControllerGrip=function(X){let J=A[X];return J===void 0&&(J=new jr,A[X]=J),J.getGripSpace()},this.getHand=function(X){let J=A[X];return J===void 0&&(J=new jr,A[X]=J),J.getHandSpace()};function L(X){const J=_.indexOf(X.inputSource);if(J===-1)return;const Et=A[J];Et!==void 0&&(Et.update(X.inputSource,X.frame,l||a),Et.dispatchEvent({type:X.type,data:X.inputSource}))}function G(){r.removeEventListener("select",L),r.removeEventListener("selectstart",L),r.removeEventListener("selectend",L),r.removeEventListener("squeeze",L),r.removeEventListener("squeezestart",L),r.removeEventListener("squeezeend",L),r.removeEventListener("end",G),r.removeEventListener("inputsourceschange",K);for(let X=0;X<A.length;X++){const J=_[X];J!==null&&(_[X]=null,A[X].disconnect(J))}R=null,z=null,x.reset(),t.setRenderTarget(u),m=null,f=null,d=null,r=null,T=null,Rt.stop(),n.isPresenting=!1,t.setPixelRatio(b),t.setSize(B.width,B.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(X){s=X,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(X){o=X,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||a},this.setReferenceSpace=function(X){l=X},this.getBaseLayer=function(){return f!==null?f:m},this.getBinding=function(){return d},this.getFrame=function(){return v},this.getSession=function(){return r},this.setSession=async function(X){if(r=X,r!==null){if(u=t.getRenderTarget(),r.addEventListener("select",L),r.addEventListener("selectstart",L),r.addEventListener("selectend",L),r.addEventListener("squeeze",L),r.addEventListener("squeezestart",L),r.addEventListener("squeezeend",L),r.addEventListener("end",G),r.addEventListener("inputsourceschange",K),p.xrCompatible!==!0&&await e.makeXRCompatible(),b=t.getPixelRatio(),t.getSize(B),r.renderState.layers===void 0){const J={antialias:p.antialias,alpha:!0,depth:p.depth,stencil:p.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(r,e,J),r.updateRenderState({baseLayer:m}),t.setPixelRatio(1),t.setSize(m.framebufferWidth,m.framebufferHeight,!1),T=new Bn(m.framebufferWidth,m.framebufferHeight,{format:Ge,type:ln,colorSpace:t.outputColorSpace,stencilBuffer:p.stencil})}else{let J=null,Et=null,ht=null;p.depth&&(ht=p.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,J=p.stencil?hi:si,Et=p.stencil?ui:On);const Lt={colorFormat:e.RGBA8,depthFormat:ht,scaleFactor:s};d=new XRWebGLBinding(r,e),f=d.createProjectionLayer(Lt),r.updateRenderState({layers:[f]}),t.setPixelRatio(1),t.setSize(f.textureWidth,f.textureHeight,!1),T=new Bn(f.textureWidth,f.textureHeight,{format:Ge,type:ln,depthTexture:new Wo(f.textureWidth,f.textureHeight,Et,void 0,void 0,void 0,void 0,void 0,void 0,J),stencilBuffer:p.stencil,colorSpace:t.outputColorSpace,samples:p.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1})}T.isXRRenderTarget=!0,this.setFoveation(c),l=null,a=await r.requestReferenceSpace(o),Rt.setContext(r),Rt.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return x.getDepthTexture()};function K(X){for(let J=0;J<X.removed.length;J++){const Et=X.removed[J],ht=_.indexOf(Et);ht>=0&&(_[ht]=null,A[ht].disconnect(Et))}for(let J=0;J<X.added.length;J++){const Et=X.added[J];let ht=_.indexOf(Et);if(ht===-1){for(let Nt=0;Nt<A.length;Nt++)if(Nt>=_.length){_.push(Et),ht=Nt;break}else if(_[Nt]===null){_[Nt]=Et,ht=Nt;break}if(ht===-1)break}const Lt=A[ht];Lt&&Lt.connect(Et)}}const W=new H,tt=new H;function D(X,J,Et){W.setFromMatrixPosition(J.matrixWorld),tt.setFromMatrixPosition(Et.matrixWorld);const ht=W.distanceTo(tt),Lt=J.projectionMatrix.elements,Nt=Et.projectionMatrix.elements,Ht=Lt[14]/(Lt[10]-1),ee=Lt[14]/(Lt[10]+1),Gt=(Lt[9]+1)/Lt[5],se=(Lt[9]-1)/Lt[5],N=(Lt[8]-1)/Lt[0],O=(Nt[8]+1)/Nt[0],dt=Ht*N,ot=Ht*O,lt=ht/(-N+O),Ct=lt*-N;if(J.matrixWorld.decompose(X.position,X.quaternion,X.scale),X.translateX(Ct),X.translateZ(lt),X.matrixWorld.compose(X.position,X.quaternion,X.scale),X.matrixWorldInverse.copy(X.matrixWorld).invert(),Lt[10]===-1)X.projectionMatrix.copy(J.projectionMatrix),X.projectionMatrixInverse.copy(J.projectionMatrixInverse);else{const gt=Ht+lt,E=ee+lt,g=dt-Ct,F=ot+(ht-Ct),Z=Gt*ee/E*gt,$=se*ee/E*gt;X.projectionMatrix.makePerspective(g,F,Z,$,gt,E),X.projectionMatrixInverse.copy(X.projectionMatrix).invert()}}function et(X,J){J===null?X.matrixWorld.copy(X.matrix):X.matrixWorld.multiplyMatrices(J.matrixWorld,X.matrix),X.matrixWorldInverse.copy(X.matrixWorld).invert()}this.updateCamera=function(X){if(r===null)return;let J=X.near,Et=X.far;x.texture!==null&&(x.depthNear>0&&(J=x.depthNear),x.depthFar>0&&(Et=x.depthFar)),M.near=P.near=w.near=J,M.far=P.far=w.far=Et,(R!==M.near||z!==M.far)&&(r.updateRenderState({depthNear:M.near,depthFar:M.far}),R=M.near,z=M.far),w.layers.mask=X.layers.mask|2,P.layers.mask=X.layers.mask|4,M.layers.mask=w.layers.mask|P.layers.mask;const ht=X.parent,Lt=M.cameras;et(M,ht);for(let Nt=0;Nt<Lt.length;Nt++)et(Lt[Nt],ht);Lt.length===2?D(M,w,P):M.projectionMatrix.copy(w.projectionMatrix),it(X,M,ht)};function it(X,J,Et){Et===null?X.matrix.copy(J.matrixWorld):(X.matrix.copy(Et.matrixWorld),X.matrix.invert(),X.matrix.multiply(J.matrixWorld)),X.matrix.decompose(X.position,X.quaternion,X.scale),X.updateMatrixWorld(!0),X.projectionMatrix.copy(J.projectionMatrix),X.projectionMatrixInverse.copy(J.projectionMatrixInverse),X.isPerspectiveCamera&&(X.fov=Ii*2*Math.atan(1/X.projectionMatrix.elements[5]),X.zoom=1)}this.getCamera=function(){return M},this.getFoveation=function(){if(!(f===null&&m===null))return c},this.setFoveation=function(X){c=X,f!==null&&(f.fixedFoveation=X),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=X)},this.hasDepthSensing=function(){return x.texture!==null},this.getDepthSensingMesh=function(){return x.getMesh(M)};let ut=null;function vt(X,J){if(h=J.getViewerPose(l||a),v=J,h!==null){const Et=h.views;m!==null&&(t.setRenderTargetFramebuffer(T,m.framebuffer),t.setRenderTarget(T));let ht=!1;Et.length!==M.cameras.length&&(M.cameras.length=0,ht=!0);for(let Nt=0;Nt<Et.length;Nt++){const Ht=Et[Nt];let ee=null;if(m!==null)ee=m.getViewport(Ht);else{const se=d.getViewSubImage(f,Ht);ee=se.viewport,Nt===0&&(t.setRenderTargetTextures(T,se.colorTexture,f.ignoreDepthValues?void 0:se.depthStencilTexture),t.setRenderTarget(T))}let Gt=y[Nt];Gt===void 0&&(Gt=new Ue,Gt.layers.enable(Nt),Gt.viewport=new ae,y[Nt]=Gt),Gt.matrix.fromArray(Ht.transform.matrix),Gt.matrix.decompose(Gt.position,Gt.quaternion,Gt.scale),Gt.projectionMatrix.fromArray(Ht.projectionMatrix),Gt.projectionMatrixInverse.copy(Gt.projectionMatrix).invert(),Gt.viewport.set(ee.x,ee.y,ee.width,ee.height),Nt===0&&(M.matrix.copy(Gt.matrix),M.matrix.decompose(M.position,M.quaternion,M.scale)),ht===!0&&M.cameras.push(Gt)}const Lt=r.enabledFeatures;if(Lt&&Lt.includes("depth-sensing")){const Nt=d.getDepthInformation(Et[0]);Nt&&Nt.isValid&&Nt.texture&&x.init(t,Nt,r.renderState)}}for(let Et=0;Et<A.length;Et++){const ht=_[Et],Lt=A[Et];ht!==null&&Lt!==void 0&&Lt.update(ht,J,l||a)}ut&&ut(X,J),J.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:J}),v=null}const Rt=new Vo;Rt.setAnimationLoop(vt),this.setAnimationLoop=function(X){ut=X},this.dispose=function(){}}}const Cn=new je,fp=new re;function pp(i,t){function e(p,u){p.matrixAutoUpdate===!0&&p.updateMatrix(),u.value.copy(p.matrix)}function n(p,u){u.color.getRGB(p.fogColor.value,zo(i)),u.isFog?(p.fogNear.value=u.near,p.fogFar.value=u.far):u.isFogExp2&&(p.fogDensity.value=u.density)}function r(p,u,T,A,_){u.isMeshBasicMaterial||u.isMeshLambertMaterial?s(p,u):u.isMeshToonMaterial?(s(p,u),d(p,u)):u.isMeshPhongMaterial?(s(p,u),h(p,u)):u.isMeshStandardMaterial?(s(p,u),f(p,u),u.isMeshPhysicalMaterial&&m(p,u,_)):u.isMeshMatcapMaterial?(s(p,u),v(p,u)):u.isMeshDepthMaterial?s(p,u):u.isMeshDistanceMaterial?(s(p,u),x(p,u)):u.isMeshNormalMaterial?s(p,u):u.isLineBasicMaterial?(a(p,u),u.isLineDashedMaterial&&o(p,u)):u.isPointsMaterial?c(p,u,T,A):u.isSpriteMaterial?l(p,u):u.isShadowMaterial?(p.color.value.copy(u.color),p.opacity.value=u.opacity):u.isShaderMaterial&&(u.uniformsNeedUpdate=!1)}function s(p,u){p.opacity.value=u.opacity,u.color&&p.diffuse.value.copy(u.color),u.emissive&&p.emissive.value.copy(u.emissive).multiplyScalar(u.emissiveIntensity),u.map&&(p.map.value=u.map,e(u.map,p.mapTransform)),u.alphaMap&&(p.alphaMap.value=u.alphaMap,e(u.alphaMap,p.alphaMapTransform)),u.bumpMap&&(p.bumpMap.value=u.bumpMap,e(u.bumpMap,p.bumpMapTransform),p.bumpScale.value=u.bumpScale,u.side===Ee&&(p.bumpScale.value*=-1)),u.normalMap&&(p.normalMap.value=u.normalMap,e(u.normalMap,p.normalMapTransform),p.normalScale.value.copy(u.normalScale),u.side===Ee&&p.normalScale.value.negate()),u.displacementMap&&(p.displacementMap.value=u.displacementMap,e(u.displacementMap,p.displacementMapTransform),p.displacementScale.value=u.displacementScale,p.displacementBias.value=u.displacementBias),u.emissiveMap&&(p.emissiveMap.value=u.emissiveMap,e(u.emissiveMap,p.emissiveMapTransform)),u.specularMap&&(p.specularMap.value=u.specularMap,e(u.specularMap,p.specularMapTransform)),u.alphaTest>0&&(p.alphaTest.value=u.alphaTest);const T=t.get(u),A=T.envMap,_=T.envMapRotation;A&&(p.envMap.value=A,Cn.copy(_),Cn.x*=-1,Cn.y*=-1,Cn.z*=-1,A.isCubeTexture&&A.isRenderTargetTexture===!1&&(Cn.y*=-1,Cn.z*=-1),p.envMapRotation.value.setFromMatrix4(fp.makeRotationFromEuler(Cn)),p.flipEnvMap.value=A.isCubeTexture&&A.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=u.reflectivity,p.ior.value=u.ior,p.refractionRatio.value=u.refractionRatio),u.lightMap&&(p.lightMap.value=u.lightMap,p.lightMapIntensity.value=u.lightMapIntensity,e(u.lightMap,p.lightMapTransform)),u.aoMap&&(p.aoMap.value=u.aoMap,p.aoMapIntensity.value=u.aoMapIntensity,e(u.aoMap,p.aoMapTransform))}function a(p,u){p.diffuse.value.copy(u.color),p.opacity.value=u.opacity,u.map&&(p.map.value=u.map,e(u.map,p.mapTransform))}function o(p,u){p.dashSize.value=u.dashSize,p.totalSize.value=u.dashSize+u.gapSize,p.scale.value=u.scale}function c(p,u,T,A){p.diffuse.value.copy(u.color),p.opacity.value=u.opacity,p.size.value=u.size*T,p.scale.value=A*.5,u.map&&(p.map.value=u.map,e(u.map,p.uvTransform)),u.alphaMap&&(p.alphaMap.value=u.alphaMap,e(u.alphaMap,p.alphaMapTransform)),u.alphaTest>0&&(p.alphaTest.value=u.alphaTest)}function l(p,u){p.diffuse.value.copy(u.color),p.opacity.value=u.opacity,p.rotation.value=u.rotation,u.map&&(p.map.value=u.map,e(u.map,p.mapTransform)),u.alphaMap&&(p.alphaMap.value=u.alphaMap,e(u.alphaMap,p.alphaMapTransform)),u.alphaTest>0&&(p.alphaTest.value=u.alphaTest)}function h(p,u){p.specular.value.copy(u.specular),p.shininess.value=Math.max(u.shininess,1e-4)}function d(p,u){u.gradientMap&&(p.gradientMap.value=u.gradientMap)}function f(p,u){p.metalness.value=u.metalness,u.metalnessMap&&(p.metalnessMap.value=u.metalnessMap,e(u.metalnessMap,p.metalnessMapTransform)),p.roughness.value=u.roughness,u.roughnessMap&&(p.roughnessMap.value=u.roughnessMap,e(u.roughnessMap,p.roughnessMapTransform)),u.envMap&&(p.envMapIntensity.value=u.envMapIntensity)}function m(p,u,T){p.ior.value=u.ior,u.sheen>0&&(p.sheenColor.value.copy(u.sheenColor).multiplyScalar(u.sheen),p.sheenRoughness.value=u.sheenRoughness,u.sheenColorMap&&(p.sheenColorMap.value=u.sheenColorMap,e(u.sheenColorMap,p.sheenColorMapTransform)),u.sheenRoughnessMap&&(p.sheenRoughnessMap.value=u.sheenRoughnessMap,e(u.sheenRoughnessMap,p.sheenRoughnessMapTransform))),u.clearcoat>0&&(p.clearcoat.value=u.clearcoat,p.clearcoatRoughness.value=u.clearcoatRoughness,u.clearcoatMap&&(p.clearcoatMap.value=u.clearcoatMap,e(u.clearcoatMap,p.clearcoatMapTransform)),u.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=u.clearcoatRoughnessMap,e(u.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),u.clearcoatNormalMap&&(p.clearcoatNormalMap.value=u.clearcoatNormalMap,e(u.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(u.clearcoatNormalScale),u.side===Ee&&p.clearcoatNormalScale.value.negate())),u.dispersion>0&&(p.dispersion.value=u.dispersion),u.iridescence>0&&(p.iridescence.value=u.iridescence,p.iridescenceIOR.value=u.iridescenceIOR,p.iridescenceThicknessMinimum.value=u.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=u.iridescenceThicknessRange[1],u.iridescenceMap&&(p.iridescenceMap.value=u.iridescenceMap,e(u.iridescenceMap,p.iridescenceMapTransform)),u.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=u.iridescenceThicknessMap,e(u.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),u.transmission>0&&(p.transmission.value=u.transmission,p.transmissionSamplerMap.value=T.texture,p.transmissionSamplerSize.value.set(T.width,T.height),u.transmissionMap&&(p.transmissionMap.value=u.transmissionMap,e(u.transmissionMap,p.transmissionMapTransform)),p.thickness.value=u.thickness,u.thicknessMap&&(p.thicknessMap.value=u.thicknessMap,e(u.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=u.attenuationDistance,p.attenuationColor.value.copy(u.attenuationColor)),u.anisotropy>0&&(p.anisotropyVector.value.set(u.anisotropy*Math.cos(u.anisotropyRotation),u.anisotropy*Math.sin(u.anisotropyRotation)),u.anisotropyMap&&(p.anisotropyMap.value=u.anisotropyMap,e(u.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=u.specularIntensity,p.specularColor.value.copy(u.specularColor),u.specularColorMap&&(p.specularColorMap.value=u.specularColorMap,e(u.specularColorMap,p.specularColorMapTransform)),u.specularIntensityMap&&(p.specularIntensityMap.value=u.specularIntensityMap,e(u.specularIntensityMap,p.specularIntensityMapTransform))}function v(p,u){u.matcap&&(p.matcap.value=u.matcap)}function x(p,u){const T=t.get(u).light;p.referencePosition.value.setFromMatrixPosition(T.matrixWorld),p.nearDistance.value=T.shadow.camera.near,p.farDistance.value=T.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function mp(i,t,e,n){let r={},s={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function c(T,A){const _=A.program;n.uniformBlockBinding(T,_)}function l(T,A){let _=r[T.id];_===void 0&&(v(T),_=h(T),r[T.id]=_,T.addEventListener("dispose",p));const B=A.program;n.updateUBOMapping(T,B);const b=t.render.frame;s[T.id]!==b&&(f(T),s[T.id]=b)}function h(T){const A=d();T.__bindingPointIndex=A;const _=i.createBuffer(),B=T.__size,b=T.usage;return i.bindBuffer(i.UNIFORM_BUFFER,_),i.bufferData(i.UNIFORM_BUFFER,B,b),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,A,_),_}function d(){for(let T=0;T<o;T++)if(a.indexOf(T)===-1)return a.push(T),T;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(T){const A=r[T.id],_=T.uniforms,B=T.__cache;i.bindBuffer(i.UNIFORM_BUFFER,A);for(let b=0,w=_.length;b<w;b++){const P=Array.isArray(_[b])?_[b]:[_[b]];for(let y=0,M=P.length;y<M;y++){const R=P[y];if(m(R,b,y,B)===!0){const z=R.__offset,L=Array.isArray(R.value)?R.value:[R.value];let G=0;for(let K=0;K<L.length;K++){const W=L[K],tt=x(W);typeof W=="number"||typeof W=="boolean"?(R.__data[0]=W,i.bufferSubData(i.UNIFORM_BUFFER,z+G,R.__data)):W.isMatrix3?(R.__data[0]=W.elements[0],R.__data[1]=W.elements[1],R.__data[2]=W.elements[2],R.__data[3]=0,R.__data[4]=W.elements[3],R.__data[5]=W.elements[4],R.__data[6]=W.elements[5],R.__data[7]=0,R.__data[8]=W.elements[6],R.__data[9]=W.elements[7],R.__data[10]=W.elements[8],R.__data[11]=0):(W.toArray(R.__data,G),G+=tt.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,z,R.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function m(T,A,_,B){const b=T.value,w=A+"_"+_;if(B[w]===void 0)return typeof b=="number"||typeof b=="boolean"?B[w]=b:B[w]=b.clone(),!0;{const P=B[w];if(typeof b=="number"||typeof b=="boolean"){if(P!==b)return B[w]=b,!0}else if(P.equals(b)===!1)return P.copy(b),!0}return!1}function v(T){const A=T.uniforms;let _=0;const B=16;for(let w=0,P=A.length;w<P;w++){const y=Array.isArray(A[w])?A[w]:[A[w]];for(let M=0,R=y.length;M<R;M++){const z=y[M],L=Array.isArray(z.value)?z.value:[z.value];for(let G=0,K=L.length;G<K;G++){const W=L[G],tt=x(W),D=_%B,et=D%tt.boundary,it=D+et;_+=et,it!==0&&B-it<tt.storage&&(_+=B-it),z.__data=new Float32Array(tt.storage/Float32Array.BYTES_PER_ELEMENT),z.__offset=_,_+=tt.storage}}}const b=_%B;return b>0&&(_+=B-b),T.__size=_,T.__cache={},this}function x(T){const A={boundary:0,storage:0};return typeof T=="number"||typeof T=="boolean"?(A.boundary=4,A.storage=4):T.isVector2?(A.boundary=8,A.storage=8):T.isVector3||T.isColor?(A.boundary=16,A.storage=12):T.isVector4?(A.boundary=16,A.storage=16):T.isMatrix3?(A.boundary=48,A.storage=48):T.isMatrix4?(A.boundary=64,A.storage=64):T.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",T),A}function p(T){const A=T.target;A.removeEventListener("dispose",p);const _=a.indexOf(A.__bindingPointIndex);a.splice(_,1),i.deleteBuffer(r[A.id]),delete r[A.id],delete s[A.id]}function u(){for(const T in r)i.deleteBuffer(r[T]);a=[],r={},s={}}return{bind:c,update:l,dispose:u}}class gp{constructor(t={}){const{canvas:e=nl(),context:n=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:d=!1,reverseDepthBuffer:f=!1}=t;this.isWebGLRenderer=!0;let m;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");m=n.getContextAttributes().alpha}else m=a;const v=new Uint32Array(4),x=new Int32Array(4);let p=null,u=null;const T=[],A=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=we,this.toneMapping=Mn,this.toneMappingExposure=1;const _=this;let B=!1,b=0,w=0,P=null,y=-1,M=null;const R=new ae,z=new ae;let L=null;const G=new Vt(0);let K=0,W=e.width,tt=e.height,D=1,et=null,it=null;const ut=new ae(0,0,W,tt),vt=new ae(0,0,W,tt);let Rt=!1;const X=new js;let J=!1,Et=!1;const ht=new re,Lt=new re,Nt=new H,Ht=new ae,ee={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Gt=!1;function se(){return P===null?D:1}let N=n;function O(S,I){return e.getContext(S,I)}try{const S={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:h,failIfMajorPerformanceCaveat:d};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${ks}`),e.addEventListener("webglcontextlost",Q,!1),e.addEventListener("webglcontextrestored",mt,!1),e.addEventListener("webglcontextcreationerror",nt,!1),N===null){const I="webgl2";if(N=O(I,S),N===null)throw O(I)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(S){throw console.error("THREE.WebGLRenderer: "+S.message),S}let dt,ot,lt,Ct,gt,E,g,F,Z,$,Y,Mt,at,ct,Ut,rt,St,Pt,Dt,xt,kt,It,Yt,C;function ft(){dt=new Md(N),dt.init(),It=new ap(N,dt),ot=new pd(N,dt,t,It),lt=new ip(N,dt),ot.reverseDepthBuffer&&f&&lt.buffers.depth.setReversed(!0),Ct=new Ed(N),gt=new Vf,E=new sp(N,dt,lt,gt,ot,It,Ct),g=new gd(_),F=new xd(_),Z=new Pl(N),Yt=new dd(N,Z),$=new Sd(N,Z,Ct,Yt),Y=new Ad(N,$,Z,Ct),Dt=new Td(N,ot,E),rt=new md(gt),Mt=new kf(_,g,F,dt,ot,Yt,rt),at=new pp(_,gt),ct=new Wf,Ut=new $f(dt),Pt=new hd(_,g,F,lt,Y,m,c),St=new ep(_,Y,ot),C=new mp(N,Ct,ot,lt),xt=new fd(N,dt,Ct),kt=new yd(N,dt,Ct),Ct.programs=Mt.programs,_.capabilities=ot,_.extensions=dt,_.properties=gt,_.renderLists=ct,_.shadowMap=St,_.state=lt,_.info=Ct}ft();const q=new dp(_,N);this.xr=q,this.getContext=function(){return N},this.getContextAttributes=function(){return N.getContextAttributes()},this.forceContextLoss=function(){const S=dt.get("WEBGL_lose_context");S&&S.loseContext()},this.forceContextRestore=function(){const S=dt.get("WEBGL_lose_context");S&&S.restoreContext()},this.getPixelRatio=function(){return D},this.setPixelRatio=function(S){S!==void 0&&(D=S,this.setSize(W,tt,!1))},this.getSize=function(S){return S.set(W,tt)},this.setSize=function(S,I,k=!0){if(q.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}W=S,tt=I,e.width=Math.floor(S*D),e.height=Math.floor(I*D),k===!0&&(e.style.width=S+"px",e.style.height=I+"px"),this.setViewport(0,0,S,I)},this.getDrawingBufferSize=function(S){return S.set(W*D,tt*D).floor()},this.setDrawingBufferSize=function(S,I,k){W=S,tt=I,D=k,e.width=Math.floor(S*k),e.height=Math.floor(I*k),this.setViewport(0,0,S,I)},this.getCurrentViewport=function(S){return S.copy(R)},this.getViewport=function(S){return S.copy(ut)},this.setViewport=function(S,I,k,V){S.isVector4?ut.set(S.x,S.y,S.z,S.w):ut.set(S,I,k,V),lt.viewport(R.copy(ut).multiplyScalar(D).round())},this.getScissor=function(S){return S.copy(vt)},this.setScissor=function(S,I,k,V){S.isVector4?vt.set(S.x,S.y,S.z,S.w):vt.set(S,I,k,V),lt.scissor(z.copy(vt).multiplyScalar(D).round())},this.getScissorTest=function(){return Rt},this.setScissorTest=function(S){lt.setScissorTest(Rt=S)},this.setOpaqueSort=function(S){et=S},this.setTransparentSort=function(S){it=S},this.getClearColor=function(S){return S.copy(Pt.getClearColor())},this.setClearColor=function(){Pt.setClearColor.apply(Pt,arguments)},this.getClearAlpha=function(){return Pt.getClearAlpha()},this.setClearAlpha=function(){Pt.setClearAlpha.apply(Pt,arguments)},this.clear=function(S=!0,I=!0,k=!0){let V=0;if(S){let U=!1;if(P!==null){const st=P.texture.format;U=st===Zs||st===Ks||st===Ys}if(U){const st=P.texture.type,_t=st===ln||st===On||st===Di||st===ui||st===Ws||st===Xs,Tt=Pt.getClearColor(),At=Pt.getClearAlpha(),Ft=Tt.r,Ot=Tt.g,bt=Tt.b;_t?(v[0]=Ft,v[1]=Ot,v[2]=bt,v[3]=At,N.clearBufferuiv(N.COLOR,0,v)):(x[0]=Ft,x[1]=Ot,x[2]=bt,x[3]=At,N.clearBufferiv(N.COLOR,0,x))}else V|=N.COLOR_BUFFER_BIT}I&&(V|=N.DEPTH_BUFFER_BIT),k&&(V|=N.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),N.clear(V)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",Q,!1),e.removeEventListener("webglcontextrestored",mt,!1),e.removeEventListener("webglcontextcreationerror",nt,!1),ct.dispose(),Ut.dispose(),gt.dispose(),g.dispose(),F.dispose(),Y.dispose(),Yt.dispose(),C.dispose(),Mt.dispose(),q.dispose(),q.removeEventListener("sessionstart",na),q.removeEventListener("sessionend",ia),En.stop()};function Q(S){S.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),B=!0}function mt(){console.log("THREE.WebGLRenderer: Context Restored."),B=!1;const S=Ct.autoReset,I=St.enabled,k=St.autoUpdate,V=St.needsUpdate,U=St.type;ft(),Ct.autoReset=S,St.enabled=I,St.autoUpdate=k,St.needsUpdate=V,St.type=U}function nt(S){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",S.statusMessage)}function yt(S){const I=S.target;I.removeEventListener("dispose",yt),Jt(I)}function Jt(S){ce(S),gt.remove(S)}function ce(S){const I=gt.get(S).programs;I!==void 0&&(I.forEach(function(k){Mt.releaseProgram(k)}),S.isShaderMaterial&&Mt.releaseShaderCache(S))}this.renderBufferDirect=function(S,I,k,V,U,st){I===null&&(I=ee);const _t=U.isMesh&&U.matrixWorld.determinant()<0,Tt=$o(S,I,k,V,U);lt.setMaterial(V,_t);let At=k.index,Ft=1;if(V.wireframe===!0){if(At=$.getWireframeAttribute(k),At===void 0)return;Ft=2}const Ot=k.drawRange,bt=k.attributes.position;let Kt=Ot.start*Ft,Qt=(Ot.start+Ot.count)*Ft;st!==null&&(Kt=Math.max(Kt,st.start*Ft),Qt=Math.min(Qt,(st.start+st.count)*Ft)),At!==null?(Kt=Math.max(Kt,0),Qt=Math.min(Qt,At.count)):bt!=null&&(Kt=Math.max(Kt,0),Qt=Math.min(Qt,bt.count));const ne=Qt-Kt;if(ne<0||ne===1/0)return;Yt.setup(U,V,Tt,k,At);let ye,Zt=xt;if(At!==null&&(ye=Z.get(At),Zt=kt,Zt.setIndex(ye)),U.isMesh)V.wireframe===!0?(lt.setLineWidth(V.wireframeLinewidth*se()),Zt.setMode(N.LINES)):Zt.setMode(N.TRIANGLES);else if(U.isLine){let wt=V.linewidth;wt===void 0&&(wt=1),lt.setLineWidth(wt*se()),U.isLineSegments?Zt.setMode(N.LINES):U.isLineLoop?Zt.setMode(N.LINE_LOOP):Zt.setMode(N.LINE_STRIP)}else U.isPoints?Zt.setMode(N.POINTS):U.isSprite&&Zt.setMode(N.TRIANGLES);if(U.isBatchedMesh)if(U._multiDrawInstances!==null)Zt.renderMultiDrawInstances(U._multiDrawStarts,U._multiDrawCounts,U._multiDrawCount,U._multiDrawInstances);else if(dt.get("WEBGL_multi_draw"))Zt.renderMultiDraw(U._multiDrawStarts,U._multiDrawCounts,U._multiDrawCount);else{const wt=U._multiDrawStarts,Qe=U._multiDrawCounts,$t=U._multiDrawCount,Oe=At?Z.get(At).bytesPerElement:1,Hn=gt.get(V).currentProgram.getUniforms();for(let Te=0;Te<$t;Te++)Hn.setValue(N,"_gl_DrawID",Te),Zt.render(wt[Te]/Oe,Qe[Te])}else if(U.isInstancedMesh)Zt.renderInstances(Kt,ne,U.count);else if(k.isInstancedBufferGeometry){const wt=k._maxInstanceCount!==void 0?k._maxInstanceCount:1/0,Qe=Math.min(k.instanceCount,wt);Zt.renderInstances(Kt,ne,Qe)}else Zt.render(Kt,ne)};function Wt(S,I,k){S.transparent===!0&&S.side===Ne&&S.forceSinglePass===!1?(S.side=Ee,S.needsUpdate=!0,ki(S,I,k),S.side=Sn,S.needsUpdate=!0,ki(S,I,k),S.side=Ne):ki(S,I,k)}this.compile=function(S,I,k=null){k===null&&(k=S),u=Ut.get(k),u.init(I),A.push(u),k.traverseVisible(function(U){U.isLight&&U.layers.test(I.layers)&&(u.pushLight(U),U.castShadow&&u.pushShadow(U))}),S!==k&&S.traverseVisible(function(U){U.isLight&&U.layers.test(I.layers)&&(u.pushLight(U),U.castShadow&&u.pushShadow(U))}),u.setupLights();const V=new Set;return S.traverse(function(U){if(!(U.isMesh||U.isPoints||U.isLine||U.isSprite))return;const st=U.material;if(st)if(Array.isArray(st))for(let _t=0;_t<st.length;_t++){const Tt=st[_t];Wt(Tt,k,U),V.add(Tt)}else Wt(st,k,U),V.add(st)}),A.pop(),u=null,V},this.compileAsync=function(S,I,k=null){const V=this.compile(S,I,k);return new Promise(U=>{function st(){if(V.forEach(function(_t){gt.get(_t).currentProgram.isReady()&&V.delete(_t)}),V.size===0){U(S);return}setTimeout(st,10)}dt.get("KHR_parallel_shader_compile")!==null?st():setTimeout(st,10)})};let Se=null;function Je(S){Se&&Se(S)}function na(){En.stop()}function ia(){En.start()}const En=new Vo;En.setAnimationLoop(Je),typeof self<"u"&&En.setContext(self),this.setAnimationLoop=function(S){Se=S,q.setAnimationLoop(S),S===null?En.stop():En.start()},q.addEventListener("sessionstart",na),q.addEventListener("sessionend",ia),this.render=function(S,I){if(I!==void 0&&I.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(B===!0)return;if(S.matrixWorldAutoUpdate===!0&&S.updateMatrixWorld(),I.parent===null&&I.matrixWorldAutoUpdate===!0&&I.updateMatrixWorld(),q.enabled===!0&&q.isPresenting===!0&&(q.cameraAutoUpdate===!0&&q.updateCamera(I),I=q.getCamera()),S.isScene===!0&&S.onBeforeRender(_,S,I,P),u=Ut.get(S,A.length),u.init(I),A.push(u),Lt.multiplyMatrices(I.projectionMatrix,I.matrixWorldInverse),X.setFromProjectionMatrix(Lt),Et=this.localClippingEnabled,J=rt.init(this.clippingPlanes,Et),p=ct.get(S,T.length),p.init(),T.push(p),q.enabled===!0&&q.isPresenting===!0){const st=_.xr.getDepthSensingMesh();st!==null&&Er(st,I,-1/0,_.sortObjects)}Er(S,I,0,_.sortObjects),p.finish(),_.sortObjects===!0&&p.sort(et,it),Gt=q.enabled===!1||q.isPresenting===!1||q.hasDepthSensing()===!1,Gt&&Pt.addToRenderList(p,S),this.info.render.frame++,J===!0&&rt.beginShadows();const k=u.state.shadowsArray;St.render(k,S,I),J===!0&&rt.endShadows(),this.info.autoReset===!0&&this.info.reset();const V=p.opaque,U=p.transmissive;if(u.setupLights(),I.isArrayCamera){const st=I.cameras;if(U.length>0)for(let _t=0,Tt=st.length;_t<Tt;_t++){const At=st[_t];sa(V,U,S,At)}Gt&&Pt.render(S);for(let _t=0,Tt=st.length;_t<Tt;_t++){const At=st[_t];ra(p,S,At,At.viewport)}}else U.length>0&&sa(V,U,S,I),Gt&&Pt.render(S),ra(p,S,I);P!==null&&(E.updateMultisampleRenderTarget(P),E.updateRenderTargetMipmap(P)),S.isScene===!0&&S.onAfterRender(_,S,I),Yt.resetDefaultState(),y=-1,M=null,A.pop(),A.length>0?(u=A[A.length-1],J===!0&&rt.setGlobalState(_.clippingPlanes,u.state.camera)):u=null,T.pop(),T.length>0?p=T[T.length-1]:p=null};function Er(S,I,k,V){if(S.visible===!1)return;if(S.layers.test(I.layers)){if(S.isGroup)k=S.renderOrder;else if(S.isLOD)S.autoUpdate===!0&&S.update(I);else if(S.isLight)u.pushLight(S),S.castShadow&&u.pushShadow(S);else if(S.isSprite){if(!S.frustumCulled||X.intersectsSprite(S)){V&&Ht.setFromMatrixPosition(S.matrixWorld).applyMatrix4(Lt);const _t=Y.update(S),Tt=S.material;Tt.visible&&p.push(S,_t,Tt,k,Ht.z,null)}}else if((S.isMesh||S.isLine||S.isPoints)&&(!S.frustumCulled||X.intersectsObject(S))){const _t=Y.update(S),Tt=S.material;if(V&&(S.boundingSphere!==void 0?(S.boundingSphere===null&&S.computeBoundingSphere(),Ht.copy(S.boundingSphere.center)):(_t.boundingSphere===null&&_t.computeBoundingSphere(),Ht.copy(_t.boundingSphere.center)),Ht.applyMatrix4(S.matrixWorld).applyMatrix4(Lt)),Array.isArray(Tt)){const At=_t.groups;for(let Ft=0,Ot=At.length;Ft<Ot;Ft++){const bt=At[Ft],Kt=Tt[bt.materialIndex];Kt&&Kt.visible&&p.push(S,_t,Kt,k,Ht.z,bt)}}else Tt.visible&&p.push(S,_t,Tt,k,Ht.z,null)}}const st=S.children;for(let _t=0,Tt=st.length;_t<Tt;_t++)Er(st[_t],I,k,V)}function ra(S,I,k,V){const U=S.opaque,st=S.transmissive,_t=S.transparent;u.setupLightsView(k),J===!0&&rt.setGlobalState(_.clippingPlanes,k),V&&lt.viewport(R.copy(V)),U.length>0&&Hi(U,I,k),st.length>0&&Hi(st,I,k),_t.length>0&&Hi(_t,I,k),lt.buffers.depth.setTest(!0),lt.buffers.depth.setMask(!0),lt.buffers.color.setMask(!0),lt.setPolygonOffset(!1)}function sa(S,I,k,V){if((k.isScene===!0?k.overrideMaterial:null)!==null)return;u.state.transmissionRenderTarget[V.id]===void 0&&(u.state.transmissionRenderTarget[V.id]=new Bn(1,1,{generateMipmaps:!0,type:dt.has("EXT_color_buffer_half_float")||dt.has("EXT_color_buffer_float")?Fi:ln,minFilter:Fn,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Xt.workingColorSpace}));const st=u.state.transmissionRenderTarget[V.id],_t=V.viewport||R;st.setSize(_t.z,_t.w);const Tt=_.getRenderTarget();_.setRenderTarget(st),_.getClearColor(G),K=_.getClearAlpha(),K<1&&_.setClearColor(16777215,.5),_.clear(),Gt&&Pt.render(k);const At=_.toneMapping;_.toneMapping=Mn;const Ft=V.viewport;if(V.viewport!==void 0&&(V.viewport=void 0),u.setupLightsView(V),J===!0&&rt.setGlobalState(_.clippingPlanes,V),Hi(S,k,V),E.updateMultisampleRenderTarget(st),E.updateRenderTargetMipmap(st),dt.has("WEBGL_multisampled_render_to_texture")===!1){let Ot=!1;for(let bt=0,Kt=I.length;bt<Kt;bt++){const Qt=I[bt],ne=Qt.object,ye=Qt.geometry,Zt=Qt.material,wt=Qt.group;if(Zt.side===Ne&&ne.layers.test(V.layers)){const Qe=Zt.side;Zt.side=Ee,Zt.needsUpdate=!0,aa(ne,k,V,ye,Zt,wt),Zt.side=Qe,Zt.needsUpdate=!0,Ot=!0}}Ot===!0&&(E.updateMultisampleRenderTarget(st),E.updateRenderTargetMipmap(st))}_.setRenderTarget(Tt),_.setClearColor(G,K),Ft!==void 0&&(V.viewport=Ft),_.toneMapping=At}function Hi(S,I,k){const V=I.isScene===!0?I.overrideMaterial:null;for(let U=0,st=S.length;U<st;U++){const _t=S[U],Tt=_t.object,At=_t.geometry,Ft=V===null?_t.material:V,Ot=_t.group;Tt.layers.test(k.layers)&&aa(Tt,I,k,At,Ft,Ot)}}function aa(S,I,k,V,U,st){S.onBeforeRender(_,I,k,V,U,st),S.modelViewMatrix.multiplyMatrices(k.matrixWorldInverse,S.matrixWorld),S.normalMatrix.getNormalMatrix(S.modelViewMatrix),U.onBeforeRender(_,I,k,V,S,st),U.transparent===!0&&U.side===Ne&&U.forceSinglePass===!1?(U.side=Ee,U.needsUpdate=!0,_.renderBufferDirect(k,I,V,U,S,st),U.side=Sn,U.needsUpdate=!0,_.renderBufferDirect(k,I,V,U,S,st),U.side=Ne):_.renderBufferDirect(k,I,V,U,S,st),S.onAfterRender(_,I,k,V,U,st)}function ki(S,I,k){I.isScene!==!0&&(I=ee);const V=gt.get(S),U=u.state.lights,st=u.state.shadowsArray,_t=U.state.version,Tt=Mt.getParameters(S,U.state,st,I,k),At=Mt.getProgramCacheKey(Tt);let Ft=V.programs;V.environment=S.isMeshStandardMaterial?I.environment:null,V.fog=I.fog,V.envMap=(S.isMeshStandardMaterial?F:g).get(S.envMap||V.environment),V.envMapRotation=V.environment!==null&&S.envMap===null?I.environmentRotation:S.envMapRotation,Ft===void 0&&(S.addEventListener("dispose",yt),Ft=new Map,V.programs=Ft);let Ot=Ft.get(At);if(Ot!==void 0){if(V.currentProgram===Ot&&V.lightsStateVersion===_t)return ca(S,Tt),Ot}else Tt.uniforms=Mt.getUniforms(S),S.onBeforeCompile(Tt,_),Ot=Mt.acquireProgram(Tt,At),Ft.set(At,Ot),V.uniforms=Tt.uniforms;const bt=V.uniforms;return(!S.isShaderMaterial&&!S.isRawShaderMaterial||S.clipping===!0)&&(bt.clippingPlanes=rt.uniform),ca(S,Tt),V.needsLights=Jo(S),V.lightsStateVersion=_t,V.needsLights&&(bt.ambientLightColor.value=U.state.ambient,bt.lightProbe.value=U.state.probe,bt.directionalLights.value=U.state.directional,bt.directionalLightShadows.value=U.state.directionalShadow,bt.spotLights.value=U.state.spot,bt.spotLightShadows.value=U.state.spotShadow,bt.rectAreaLights.value=U.state.rectArea,bt.ltc_1.value=U.state.rectAreaLTC1,bt.ltc_2.value=U.state.rectAreaLTC2,bt.pointLights.value=U.state.point,bt.pointLightShadows.value=U.state.pointShadow,bt.hemisphereLights.value=U.state.hemi,bt.directionalShadowMap.value=U.state.directionalShadowMap,bt.directionalShadowMatrix.value=U.state.directionalShadowMatrix,bt.spotShadowMap.value=U.state.spotShadowMap,bt.spotLightMatrix.value=U.state.spotLightMatrix,bt.spotLightMap.value=U.state.spotLightMap,bt.pointShadowMap.value=U.state.pointShadowMap,bt.pointShadowMatrix.value=U.state.pointShadowMatrix),V.currentProgram=Ot,V.uniformsList=null,Ot}function oa(S){if(S.uniformsList===null){const I=S.currentProgram.getUniforms();S.uniformsList=mr.seqWithValue(I.seq,S.uniforms)}return S.uniformsList}function ca(S,I){const k=gt.get(S);k.outputColorSpace=I.outputColorSpace,k.batching=I.batching,k.batchingColor=I.batchingColor,k.instancing=I.instancing,k.instancingColor=I.instancingColor,k.instancingMorph=I.instancingMorph,k.skinning=I.skinning,k.morphTargets=I.morphTargets,k.morphNormals=I.morphNormals,k.morphColors=I.morphColors,k.morphTargetsCount=I.morphTargetsCount,k.numClippingPlanes=I.numClippingPlanes,k.numIntersection=I.numClipIntersection,k.vertexAlphas=I.vertexAlphas,k.vertexTangents=I.vertexTangents,k.toneMapping=I.toneMapping}function $o(S,I,k,V,U){I.isScene!==!0&&(I=ee),E.resetTextureUnits();const st=I.fog,_t=V.isMeshStandardMaterial?I.environment:null,Tt=P===null?_.outputColorSpace:P.isXRRenderTarget===!0?P.texture.colorSpace:fi,At=(V.isMeshStandardMaterial?F:g).get(V.envMap||_t),Ft=V.vertexColors===!0&&!!k.attributes.color&&k.attributes.color.itemSize===4,Ot=!!k.attributes.tangent&&(!!V.normalMap||V.anisotropy>0),bt=!!k.morphAttributes.position,Kt=!!k.morphAttributes.normal,Qt=!!k.morphAttributes.color;let ne=Mn;V.toneMapped&&(P===null||P.isXRRenderTarget===!0)&&(ne=_.toneMapping);const ye=k.morphAttributes.position||k.morphAttributes.normal||k.morphAttributes.color,Zt=ye!==void 0?ye.length:0,wt=gt.get(V),Qe=u.state.lights;if(J===!0&&(Et===!0||S!==M)){const Pe=S===M&&V.id===y;rt.setState(V,S,Pe)}let $t=!1;V.version===wt.__version?(wt.needsLights&&wt.lightsStateVersion!==Qe.state.version||wt.outputColorSpace!==Tt||U.isBatchedMesh&&wt.batching===!1||!U.isBatchedMesh&&wt.batching===!0||U.isBatchedMesh&&wt.batchingColor===!0&&U.colorTexture===null||U.isBatchedMesh&&wt.batchingColor===!1&&U.colorTexture!==null||U.isInstancedMesh&&wt.instancing===!1||!U.isInstancedMesh&&wt.instancing===!0||U.isSkinnedMesh&&wt.skinning===!1||!U.isSkinnedMesh&&wt.skinning===!0||U.isInstancedMesh&&wt.instancingColor===!0&&U.instanceColor===null||U.isInstancedMesh&&wt.instancingColor===!1&&U.instanceColor!==null||U.isInstancedMesh&&wt.instancingMorph===!0&&U.morphTexture===null||U.isInstancedMesh&&wt.instancingMorph===!1&&U.morphTexture!==null||wt.envMap!==At||V.fog===!0&&wt.fog!==st||wt.numClippingPlanes!==void 0&&(wt.numClippingPlanes!==rt.numPlanes||wt.numIntersection!==rt.numIntersection)||wt.vertexAlphas!==Ft||wt.vertexTangents!==Ot||wt.morphTargets!==bt||wt.morphNormals!==Kt||wt.morphColors!==Qt||wt.toneMapping!==ne||wt.morphTargetsCount!==Zt)&&($t=!0):($t=!0,wt.__version=V.version);let Oe=wt.currentProgram;$t===!0&&(Oe=ki(V,I,U));let Hn=!1,Te=!1,_i=!1;const ie=Oe.getUniforms(),Ye=wt.uniforms;if(lt.useProgram(Oe.program)&&(Hn=!0,Te=!0,_i=!0),V.id!==y&&(y=V.id,Te=!0),Hn||M!==S){lt.buffers.depth.getReversed()?(ht.copy(S.projectionMatrix),rl(ht),sl(ht),ie.setValue(N,"projectionMatrix",ht)):ie.setValue(N,"projectionMatrix",S.projectionMatrix),ie.setValue(N,"viewMatrix",S.matrixWorldInverse);const un=ie.map.cameraPosition;un!==void 0&&un.setValue(N,Nt.setFromMatrixPosition(S.matrixWorld)),ot.logarithmicDepthBuffer&&ie.setValue(N,"logDepthBufFC",2/(Math.log(S.far+1)/Math.LN2)),(V.isMeshPhongMaterial||V.isMeshToonMaterial||V.isMeshLambertMaterial||V.isMeshBasicMaterial||V.isMeshStandardMaterial||V.isShaderMaterial)&&ie.setValue(N,"isOrthographic",S.isOrthographicCamera===!0),M!==S&&(M=S,Te=!0,_i=!0)}if(U.isSkinnedMesh){ie.setOptional(N,U,"bindMatrix"),ie.setOptional(N,U,"bindMatrixInverse");const Pe=U.skeleton;Pe&&(Pe.boneTexture===null&&Pe.computeBoneTexture(),ie.setValue(N,"boneTexture",Pe.boneTexture,E))}U.isBatchedMesh&&(ie.setOptional(N,U,"batchingTexture"),ie.setValue(N,"batchingTexture",U._matricesTexture,E),ie.setOptional(N,U,"batchingIdTexture"),ie.setValue(N,"batchingIdTexture",U._indirectTexture,E),ie.setOptional(N,U,"batchingColorTexture"),U._colorsTexture!==null&&ie.setValue(N,"batchingColorTexture",U._colorsTexture,E));const vi=k.morphAttributes;if((vi.position!==void 0||vi.normal!==void 0||vi.color!==void 0)&&Dt.update(U,k,Oe),(Te||wt.receiveShadow!==U.receiveShadow)&&(wt.receiveShadow=U.receiveShadow,ie.setValue(N,"receiveShadow",U.receiveShadow)),V.isMeshGouraudMaterial&&V.envMap!==null&&(Ye.envMap.value=At,Ye.flipEnvMap.value=At.isCubeTexture&&At.isRenderTargetTexture===!1?-1:1),V.isMeshStandardMaterial&&V.envMap===null&&I.environment!==null&&(Ye.envMapIntensity.value=I.environmentIntensity),Te&&(ie.setValue(N,"toneMappingExposure",_.toneMappingExposure),wt.needsLights&&jo(Ye,_i),st&&V.fog===!0&&at.refreshFogUniforms(Ye,st),at.refreshMaterialUniforms(Ye,V,D,tt,u.state.transmissionRenderTarget[S.id]),mr.upload(N,oa(wt),Ye,E)),V.isShaderMaterial&&V.uniformsNeedUpdate===!0&&(mr.upload(N,oa(wt),Ye,E),V.uniformsNeedUpdate=!1),V.isSpriteMaterial&&ie.setValue(N,"center",U.center),ie.setValue(N,"modelViewMatrix",U.modelViewMatrix),ie.setValue(N,"normalMatrix",U.normalMatrix),ie.setValue(N,"modelMatrix",U.matrixWorld),V.isShaderMaterial||V.isRawShaderMaterial){const Pe=V.uniformsGroups;for(let un=0,hn=Pe.length;un<hn;un++){const la=Pe[un];C.update(la,Oe),C.bind(la,Oe)}}return Oe}function jo(S,I){S.ambientLightColor.needsUpdate=I,S.lightProbe.needsUpdate=I,S.directionalLights.needsUpdate=I,S.directionalLightShadows.needsUpdate=I,S.pointLights.needsUpdate=I,S.pointLightShadows.needsUpdate=I,S.spotLights.needsUpdate=I,S.spotLightShadows.needsUpdate=I,S.rectAreaLights.needsUpdate=I,S.hemisphereLights.needsUpdate=I}function Jo(S){return S.isMeshLambertMaterial||S.isMeshToonMaterial||S.isMeshPhongMaterial||S.isMeshStandardMaterial||S.isShadowMaterial||S.isShaderMaterial&&S.lights===!0}this.getActiveCubeFace=function(){return b},this.getActiveMipmapLevel=function(){return w},this.getRenderTarget=function(){return P},this.setRenderTargetTextures=function(S,I,k){gt.get(S.texture).__webglTexture=I,gt.get(S.depthTexture).__webglTexture=k;const V=gt.get(S);V.__hasExternalTextures=!0,V.__autoAllocateDepthBuffer=k===void 0,V.__autoAllocateDepthBuffer||dt.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),V.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(S,I){const k=gt.get(S);k.__webglFramebuffer=I,k.__useDefaultFramebuffer=I===void 0},this.setRenderTarget=function(S,I=0,k=0){P=S,b=I,w=k;let V=!0,U=null,st=!1,_t=!1;if(S){const At=gt.get(S);if(At.__useDefaultFramebuffer!==void 0)lt.bindFramebuffer(N.FRAMEBUFFER,null),V=!1;else if(At.__webglFramebuffer===void 0)E.setupRenderTarget(S);else if(At.__hasExternalTextures)E.rebindTextures(S,gt.get(S.texture).__webglTexture,gt.get(S.depthTexture).__webglTexture);else if(S.depthBuffer){const bt=S.depthTexture;if(At.__boundDepthTexture!==bt){if(bt!==null&&gt.has(bt)&&(S.width!==bt.image.width||S.height!==bt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");E.setupDepthRenderbuffer(S)}}const Ft=S.texture;(Ft.isData3DTexture||Ft.isDataArrayTexture||Ft.isCompressedArrayTexture)&&(_t=!0);const Ot=gt.get(S).__webglFramebuffer;S.isWebGLCubeRenderTarget?(Array.isArray(Ot[I])?U=Ot[I][k]:U=Ot[I],st=!0):S.samples>0&&E.useMultisampledRTT(S)===!1?U=gt.get(S).__webglMultisampledFramebuffer:Array.isArray(Ot)?U=Ot[k]:U=Ot,R.copy(S.viewport),z.copy(S.scissor),L=S.scissorTest}else R.copy(ut).multiplyScalar(D).floor(),z.copy(vt).multiplyScalar(D).floor(),L=Rt;if(lt.bindFramebuffer(N.FRAMEBUFFER,U)&&V&&lt.drawBuffers(S,U),lt.viewport(R),lt.scissor(z),lt.setScissorTest(L),st){const At=gt.get(S.texture);N.framebufferTexture2D(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_CUBE_MAP_POSITIVE_X+I,At.__webglTexture,k)}else if(_t){const At=gt.get(S.texture),Ft=I||0;N.framebufferTextureLayer(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,At.__webglTexture,k||0,Ft)}y=-1},this.readRenderTargetPixels=function(S,I,k,V,U,st,_t){if(!(S&&S.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Tt=gt.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&_t!==void 0&&(Tt=Tt[_t]),Tt){lt.bindFramebuffer(N.FRAMEBUFFER,Tt);try{const At=S.texture,Ft=At.format,Ot=At.type;if(!ot.textureFormatReadable(Ft)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!ot.textureTypeReadable(Ot)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}I>=0&&I<=S.width-V&&k>=0&&k<=S.height-U&&N.readPixels(I,k,V,U,It.convert(Ft),It.convert(Ot),st)}finally{const At=P!==null?gt.get(P).__webglFramebuffer:null;lt.bindFramebuffer(N.FRAMEBUFFER,At)}}},this.readRenderTargetPixelsAsync=async function(S,I,k,V,U,st,_t){if(!(S&&S.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Tt=gt.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&_t!==void 0&&(Tt=Tt[_t]),Tt){const At=S.texture,Ft=At.format,Ot=At.type;if(!ot.textureFormatReadable(Ft))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!ot.textureTypeReadable(Ot))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(I>=0&&I<=S.width-V&&k>=0&&k<=S.height-U){lt.bindFramebuffer(N.FRAMEBUFFER,Tt);const bt=N.createBuffer();N.bindBuffer(N.PIXEL_PACK_BUFFER,bt),N.bufferData(N.PIXEL_PACK_BUFFER,st.byteLength,N.STREAM_READ),N.readPixels(I,k,V,U,It.convert(Ft),It.convert(Ot),0);const Kt=P!==null?gt.get(P).__webglFramebuffer:null;lt.bindFramebuffer(N.FRAMEBUFFER,Kt);const Qt=N.fenceSync(N.SYNC_GPU_COMMANDS_COMPLETE,0);return N.flush(),await il(N,Qt,4),N.bindBuffer(N.PIXEL_PACK_BUFFER,bt),N.getBufferSubData(N.PIXEL_PACK_BUFFER,0,st),N.deleteBuffer(bt),N.deleteSync(Qt),st}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(S,I=null,k=0){S.isTexture!==!0&&(bi("WebGLRenderer: copyFramebufferToTexture function signature has changed."),I=arguments[0]||null,S=arguments[1]);const V=Math.pow(2,-k),U=Math.floor(S.image.width*V),st=Math.floor(S.image.height*V),_t=I!==null?I.x:0,Tt=I!==null?I.y:0;E.setTexture2D(S,0),N.copyTexSubImage2D(N.TEXTURE_2D,k,0,0,_t,Tt,U,st),lt.unbindTexture()},this.copyTextureToTexture=function(S,I,k=null,V=null,U=0){S.isTexture!==!0&&(bi("WebGLRenderer: copyTextureToTexture function signature has changed."),V=arguments[0]||null,S=arguments[1],I=arguments[2],U=arguments[3]||0,k=null);let st,_t,Tt,At,Ft,Ot,bt,Kt,Qt;const ne=S.isCompressedTexture?S.mipmaps[U]:S.image;k!==null?(st=k.max.x-k.min.x,_t=k.max.y-k.min.y,Tt=k.isBox3?k.max.z-k.min.z:1,At=k.min.x,Ft=k.min.y,Ot=k.isBox3?k.min.z:0):(st=ne.width,_t=ne.height,Tt=ne.depth||1,At=0,Ft=0,Ot=0),V!==null?(bt=V.x,Kt=V.y,Qt=V.z):(bt=0,Kt=0,Qt=0);const ye=It.convert(I.format),Zt=It.convert(I.type);let wt;I.isData3DTexture?(E.setTexture3D(I,0),wt=N.TEXTURE_3D):I.isDataArrayTexture||I.isCompressedArrayTexture?(E.setTexture2DArray(I,0),wt=N.TEXTURE_2D_ARRAY):(E.setTexture2D(I,0),wt=N.TEXTURE_2D),N.pixelStorei(N.UNPACK_FLIP_Y_WEBGL,I.flipY),N.pixelStorei(N.UNPACK_PREMULTIPLY_ALPHA_WEBGL,I.premultiplyAlpha),N.pixelStorei(N.UNPACK_ALIGNMENT,I.unpackAlignment);const Qe=N.getParameter(N.UNPACK_ROW_LENGTH),$t=N.getParameter(N.UNPACK_IMAGE_HEIGHT),Oe=N.getParameter(N.UNPACK_SKIP_PIXELS),Hn=N.getParameter(N.UNPACK_SKIP_ROWS),Te=N.getParameter(N.UNPACK_SKIP_IMAGES);N.pixelStorei(N.UNPACK_ROW_LENGTH,ne.width),N.pixelStorei(N.UNPACK_IMAGE_HEIGHT,ne.height),N.pixelStorei(N.UNPACK_SKIP_PIXELS,At),N.pixelStorei(N.UNPACK_SKIP_ROWS,Ft),N.pixelStorei(N.UNPACK_SKIP_IMAGES,Ot);const _i=S.isDataArrayTexture||S.isData3DTexture,ie=I.isDataArrayTexture||I.isData3DTexture;if(S.isRenderTargetTexture||S.isDepthTexture){const Ye=gt.get(S),vi=gt.get(I),Pe=gt.get(Ye.__renderTarget),un=gt.get(vi.__renderTarget);lt.bindFramebuffer(N.READ_FRAMEBUFFER,Pe.__webglFramebuffer),lt.bindFramebuffer(N.DRAW_FRAMEBUFFER,un.__webglFramebuffer);for(let hn=0;hn<Tt;hn++)_i&&N.framebufferTextureLayer(N.READ_FRAMEBUFFER,N.COLOR_ATTACHMENT0,gt.get(S).__webglTexture,U,Ot+hn),S.isDepthTexture?(ie&&N.framebufferTextureLayer(N.DRAW_FRAMEBUFFER,N.COLOR_ATTACHMENT0,gt.get(I).__webglTexture,U,Qt+hn),N.blitFramebuffer(At,Ft,st,_t,bt,Kt,st,_t,N.DEPTH_BUFFER_BIT,N.NEAREST)):ie?N.copyTexSubImage3D(wt,U,bt,Kt,Qt+hn,At,Ft,st,_t):N.copyTexSubImage2D(wt,U,bt,Kt,Qt+hn,At,Ft,st,_t);lt.bindFramebuffer(N.READ_FRAMEBUFFER,null),lt.bindFramebuffer(N.DRAW_FRAMEBUFFER,null)}else ie?S.isDataTexture||S.isData3DTexture?N.texSubImage3D(wt,U,bt,Kt,Qt,st,_t,Tt,ye,Zt,ne.data):I.isCompressedArrayTexture?N.compressedTexSubImage3D(wt,U,bt,Kt,Qt,st,_t,Tt,ye,ne.data):N.texSubImage3D(wt,U,bt,Kt,Qt,st,_t,Tt,ye,Zt,ne):S.isDataTexture?N.texSubImage2D(N.TEXTURE_2D,U,bt,Kt,st,_t,ye,Zt,ne.data):S.isCompressedTexture?N.compressedTexSubImage2D(N.TEXTURE_2D,U,bt,Kt,ne.width,ne.height,ye,ne.data):N.texSubImage2D(N.TEXTURE_2D,U,bt,Kt,st,_t,ye,Zt,ne);N.pixelStorei(N.UNPACK_ROW_LENGTH,Qe),N.pixelStorei(N.UNPACK_IMAGE_HEIGHT,$t),N.pixelStorei(N.UNPACK_SKIP_PIXELS,Oe),N.pixelStorei(N.UNPACK_SKIP_ROWS,Hn),N.pixelStorei(N.UNPACK_SKIP_IMAGES,Te),U===0&&I.generateMipmaps&&N.generateMipmap(wt),lt.unbindTexture()},this.copyTextureToTexture3D=function(S,I,k=null,V=null,U=0){return S.isTexture!==!0&&(bi("WebGLRenderer: copyTextureToTexture3D function signature has changed."),k=arguments[0]||null,V=arguments[1]||null,S=arguments[2],I=arguments[3],U=arguments[4]||0),bi('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(S,I,k,V,U)},this.initRenderTarget=function(S){gt.get(S).__webglFramebuffer===void 0&&E.setupRenderTarget(S)},this.initTexture=function(S){S.isCubeTexture?E.setTextureCube(S,0):S.isData3DTexture?E.setTexture3D(S,0):S.isDataArrayTexture||S.isCompressedArrayTexture?E.setTexture2DArray(S,0):E.setTexture2D(S,0),lt.unbindTexture()},this.resetState=function(){b=0,w=0,P=null,lt.reset(),Yt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return on}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorspace=Xt._getDrawingBufferColorSpace(t),e.unpackColorSpace=Xt._getUnpackColorSpace()}}class Qs{constructor(t,e=1,n=1e3){this.isFog=!0,this.name="",this.color=new Vt(t),this.near=e,this.far=n}clone(){return new Qs(this.color,this.near,this.far)}toJSON(){return{type:"Fog",name:this.name,color:this.color.getHex(),near:this.near,far:this.far}}}class _p extends pe{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new je,this.environmentIntensity=1,this.environmentRotation=new je,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(t,e){return super.copy(t,e),t.background!==null&&(this.background=t.background.clone()),t.environment!==null&&(this.environment=t.environment.clone()),t.fog!==null&&(this.fog=t.fog.clone()),this.backgroundBlurriness=t.backgroundBlurriness,this.backgroundIntensity=t.backgroundIntensity,this.backgroundRotation.copy(t.backgroundRotation),this.environmentIntensity=t.environmentIntensity,this.environmentRotation.copy(t.environmentRotation),t.overrideMaterial!==null&&(this.overrideMaterial=t.overrideMaterial.clone()),this.matrixAutoUpdate=t.matrixAutoUpdate,this}toJSON(t){const e=super.toJSON(t);return this.fog!==null&&(e.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(e.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(e.object.backgroundIntensity=this.backgroundIntensity),e.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(e.object.environmentIntensity=this.environmentIntensity),e.object.environmentRotation=this.environmentRotation.toArray(),e}}class vp extends Me{constructor(t=null,e=1,n=1,r,s,a,o,c,l=Ce,h=Ce,d,f){super(null,a,o,c,l,h,r,s,d,f),this.isDataTexture=!0,this.image={data:t,width:e,height:n},this.generateMipmaps=!1,this.flipY=!1,this.unpackAlignment=1}}class Hs extends qe{constructor(t,e,n,r=1){super(t,e,n),this.isInstancedBufferAttribute=!0,this.meshPerAttribute=r}copy(t){return super.copy(t),this.meshPerAttribute=t.meshPerAttribute,this}toJSON(){const t=super.toJSON();return t.meshPerAttribute=this.meshPerAttribute,t.isInstancedBufferAttribute=!0,t}}const ei=new re,uo=new re,lr=[],ho=new zn,xp=new re,Ei=new te,Ti=new Bi;class Mp extends te{constructor(t,e,n){super(t,e),this.isInstancedMesh=!0,this.instanceMatrix=new Hs(new Float32Array(n*16),16),this.instanceColor=null,this.morphTexture=null,this.count=n,this.boundingBox=null,this.boundingSphere=null;for(let r=0;r<n;r++)this.setMatrixAt(r,xp)}computeBoundingBox(){const t=this.geometry,e=this.count;this.boundingBox===null&&(this.boundingBox=new zn),t.boundingBox===null&&t.computeBoundingBox(),this.boundingBox.makeEmpty();for(let n=0;n<e;n++)this.getMatrixAt(n,ei),ho.copy(t.boundingBox).applyMatrix4(ei),this.boundingBox.union(ho)}computeBoundingSphere(){const t=this.geometry,e=this.count;this.boundingSphere===null&&(this.boundingSphere=new Bi),t.boundingSphere===null&&t.computeBoundingSphere(),this.boundingSphere.makeEmpty();for(let n=0;n<e;n++)this.getMatrixAt(n,ei),Ti.copy(t.boundingSphere).applyMatrix4(ei),this.boundingSphere.union(Ti)}copy(t,e){return super.copy(t,e),this.instanceMatrix.copy(t.instanceMatrix),t.morphTexture!==null&&(this.morphTexture=t.morphTexture.clone()),t.instanceColor!==null&&(this.instanceColor=t.instanceColor.clone()),this.count=t.count,t.boundingBox!==null&&(this.boundingBox=t.boundingBox.clone()),t.boundingSphere!==null&&(this.boundingSphere=t.boundingSphere.clone()),this}getColorAt(t,e){e.fromArray(this.instanceColor.array,t*3)}getMatrixAt(t,e){e.fromArray(this.instanceMatrix.array,t*16)}getMorphAt(t,e){const n=e.morphTargetInfluences,r=this.morphTexture.source.data.data,s=n.length+1,a=t*s+1;for(let o=0;o<n.length;o++)n[o]=r[a+o]}raycast(t,e){const n=this.matrixWorld,r=this.count;if(Ei.geometry=this.geometry,Ei.material=this.material,Ei.material!==void 0&&(this.boundingSphere===null&&this.computeBoundingSphere(),Ti.copy(this.boundingSphere),Ti.applyMatrix4(n),t.ray.intersectsSphere(Ti)!==!1))for(let s=0;s<r;s++){this.getMatrixAt(s,ei),uo.multiplyMatrices(n,ei),Ei.matrixWorld=uo,Ei.raycast(t,lr);for(let a=0,o=lr.length;a<o;a++){const c=lr[a];c.instanceId=s,c.object=this,e.push(c)}lr.length=0}}setColorAt(t,e){this.instanceColor===null&&(this.instanceColor=new Hs(new Float32Array(this.instanceMatrix.count*3).fill(1),3)),e.toArray(this.instanceColor.array,t*3)}setMatrixAt(t,e){e.toArray(this.instanceMatrix.array,t*16)}setMorphAt(t,e){const n=e.morphTargetInfluences,r=n.length+1;this.morphTexture===null&&(this.morphTexture=new vp(new Float32Array(r*this.count),r,this.count,qs,$e));const s=this.morphTexture.source.data.data;let a=0;for(let l=0;l<n.length;l++)a+=n[l];const o=this.geometry.morphTargetsRelative?1:1-a,c=r*t;s[c]=o,s.set(n,c+1)}updateMorphTargets(){}dispose(){return this.dispatchEvent({type:"dispose"}),this.morphTexture!==null&&(this.morphTexture.dispose(),this.morphTexture=null),this}}class ta extends Fe{constructor(t=1,e=32,n=0,r=Math.PI*2){super(),this.type="CircleGeometry",this.parameters={radius:t,segments:e,thetaStart:n,thetaLength:r},e=Math.max(3,e);const s=[],a=[],o=[],c=[],l=new H,h=new qt;a.push(0,0,0),o.push(0,0,1),c.push(.5,.5);for(let d=0,f=3;d<=e;d++,f+=3){const m=n+d/e*r;l.x=t*Math.cos(m),l.y=t*Math.sin(m),a.push(l.x,l.y,l.z),o.push(0,0,1),h.x=(a[f]/t+1)/2,h.y=(a[f+1]/t+1)/2,c.push(h.x,h.y)}for(let d=1;d<=e;d++)s.push(d,d+1,0);this.setIndex(s),this.setAttribute("position",new oe(a,3)),this.setAttribute("normal",new oe(o,3)),this.setAttribute("uv",new oe(c,2))}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new ta(t.radius,t.segments,t.thetaStart,t.thetaLength)}}class Li extends Fe{constructor(t=1,e=1,n=1,r=32,s=1,a=!1,o=0,c=Math.PI*2){super(),this.type="CylinderGeometry",this.parameters={radiusTop:t,radiusBottom:e,height:n,radialSegments:r,heightSegments:s,openEnded:a,thetaStart:o,thetaLength:c};const l=this;r=Math.floor(r),s=Math.floor(s);const h=[],d=[],f=[],m=[];let v=0;const x=[],p=n/2;let u=0;T(),a===!1&&(t>0&&A(!0),e>0&&A(!1)),this.setIndex(h),this.setAttribute("position",new oe(d,3)),this.setAttribute("normal",new oe(f,3)),this.setAttribute("uv",new oe(m,2));function T(){const _=new H,B=new H;let b=0;const w=(e-t)/n;for(let P=0;P<=s;P++){const y=[],M=P/s,R=M*(e-t)+t;for(let z=0;z<=r;z++){const L=z/r,G=L*c+o,K=Math.sin(G),W=Math.cos(G);B.x=R*K,B.y=-M*n+p,B.z=R*W,d.push(B.x,B.y,B.z),_.set(K,w,W).normalize(),f.push(_.x,_.y,_.z),m.push(L,1-M),y.push(v++)}x.push(y)}for(let P=0;P<r;P++)for(let y=0;y<s;y++){const M=x[y][P],R=x[y+1][P],z=x[y+1][P+1],L=x[y][P+1];(t>0||y!==0)&&(h.push(M,R,L),b+=3),(e>0||y!==s-1)&&(h.push(R,z,L),b+=3)}l.addGroup(u,b,0),u+=b}function A(_){const B=v,b=new qt,w=new H;let P=0;const y=_===!0?t:e,M=_===!0?1:-1;for(let z=1;z<=r;z++)d.push(0,p*M,0),f.push(0,M,0),m.push(.5,.5),v++;const R=v;for(let z=0;z<=r;z++){const G=z/r*c+o,K=Math.cos(G),W=Math.sin(G);w.x=y*W,w.y=p*M,w.z=y*K,d.push(w.x,w.y,w.z),f.push(0,M,0),b.x=K*.5+.5,b.y=W*.5*M+.5,m.push(b.x,b.y),v++}for(let z=0;z<r;z++){const L=B+z,G=R+z;_===!0?h.push(G,G+1,L):h.push(G+1,G,L),P+=3}l.addGroup(u,P,_===!0?1:2),u+=P}}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new Li(t.radiusTop,t.radiusBottom,t.height,t.radialSegments,t.heightSegments,t.openEnded,t.thetaStart,t.thetaLength)}}class Ni extends Fe{constructor(t=.5,e=1,n=32,r=1,s=0,a=Math.PI*2){super(),this.type="RingGeometry",this.parameters={innerRadius:t,outerRadius:e,thetaSegments:n,phiSegments:r,thetaStart:s,thetaLength:a},n=Math.max(3,n),r=Math.max(1,r);const o=[],c=[],l=[],h=[];let d=t;const f=(e-t)/r,m=new H,v=new qt;for(let x=0;x<=r;x++){for(let p=0;p<=n;p++){const u=s+p/n*a;m.x=d*Math.cos(u),m.y=d*Math.sin(u),c.push(m.x,m.y,m.z),l.push(0,0,1),v.x=(m.x/e+1)/2,v.y=(m.y/e+1)/2,h.push(v.x,v.y)}d+=f}for(let x=0;x<r;x++){const p=x*(n+1);for(let u=0;u<n;u++){const T=u+p,A=T,_=T+n+1,B=T+n+2,b=T+1;o.push(A,_,b),o.push(_,B,b)}}this.setIndex(o),this.setAttribute("position",new oe(c,3)),this.setAttribute("normal",new oe(l,3)),this.setAttribute("uv",new oe(h,2))}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new Ni(t.innerRadius,t.outerRadius,t.thetaSegments,t.phiSegments,t.thetaStart,t.thetaLength)}}class yr extends Fe{constructor(t=1,e=32,n=16,r=0,s=Math.PI*2,a=0,o=Math.PI){super(),this.type="SphereGeometry",this.parameters={radius:t,widthSegments:e,heightSegments:n,phiStart:r,phiLength:s,thetaStart:a,thetaLength:o},e=Math.max(3,Math.floor(e)),n=Math.max(2,Math.floor(n));const c=Math.min(a+o,Math.PI);let l=0;const h=[],d=new H,f=new H,m=[],v=[],x=[],p=[];for(let u=0;u<=n;u++){const T=[],A=u/n;let _=0;u===0&&a===0?_=.5/e:u===n&&c===Math.PI&&(_=-.5/e);for(let B=0;B<=e;B++){const b=B/e;d.x=-t*Math.cos(r+b*s)*Math.sin(a+A*o),d.y=t*Math.cos(a+A*o),d.z=t*Math.sin(r+b*s)*Math.sin(a+A*o),v.push(d.x,d.y,d.z),f.copy(d).normalize(),x.push(f.x,f.y,f.z),p.push(b+_,1-A),T.push(l++)}h.push(T)}for(let u=0;u<n;u++)for(let T=0;T<e;T++){const A=h[u][T+1],_=h[u][T],B=h[u+1][T],b=h[u+1][T+1];(u!==0||a>0)&&m.push(A,_,b),(u!==n-1||c<Math.PI)&&m.push(_,B,b)}this.setIndex(m),this.setAttribute("position",new oe(v,3)),this.setAttribute("normal",new oe(x,3)),this.setAttribute("uv",new oe(p,2))}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new yr(t.radius,t.widthSegments,t.heightSegments,t.phiStart,t.phiLength,t.thetaStart,t.thetaLength)}}class ea extends Fe{constructor(t=1,e=.4,n=12,r=48,s=Math.PI*2){super(),this.type="TorusGeometry",this.parameters={radius:t,tube:e,radialSegments:n,tubularSegments:r,arc:s},n=Math.floor(n),r=Math.floor(r);const a=[],o=[],c=[],l=[],h=new H,d=new H,f=new H;for(let m=0;m<=n;m++)for(let v=0;v<=r;v++){const x=v/r*s,p=m/n*Math.PI*2;d.x=(t+e*Math.cos(p))*Math.cos(x),d.y=(t+e*Math.cos(p))*Math.sin(x),d.z=e*Math.sin(p),o.push(d.x,d.y,d.z),h.x=t*Math.cos(x),h.y=t*Math.sin(x),f.subVectors(d,h).normalize(),c.push(f.x,f.y,f.z),l.push(v/r),l.push(m/n)}for(let m=1;m<=n;m++)for(let v=1;v<=r;v++){const x=(r+1)*m+v-1,p=(r+1)*(m-1)+v-1,u=(r+1)*(m-1)+v,T=(r+1)*m+v;a.push(x,p,T),a.push(p,u,T)}this.setIndex(a),this.setAttribute("position",new oe(o,3)),this.setAttribute("normal",new oe(c,3)),this.setAttribute("uv",new oe(l,2))}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new ea(t.radius,t.tube,t.radialSegments,t.tubularSegments,t.arc)}}class Re extends zi{static get type(){return"MeshLambertMaterial"}constructor(t){super(),this.isMeshLambertMaterial=!0,this.color=new Vt(16777215),this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new Vt(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=Po,this.normalScale=new qt(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.specularMap=null,this.alphaMap=null,this.envMap=null,this.envMapRotation=new je,this.combine=Vs,this.reflectivity=1,this.refractionRatio=.98,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(t)}copy(t){return super.copy(t),this.color.copy(t.color),this.map=t.map,this.lightMap=t.lightMap,this.lightMapIntensity=t.lightMapIntensity,this.aoMap=t.aoMap,this.aoMapIntensity=t.aoMapIntensity,this.emissive.copy(t.emissive),this.emissiveMap=t.emissiveMap,this.emissiveIntensity=t.emissiveIntensity,this.bumpMap=t.bumpMap,this.bumpScale=t.bumpScale,this.normalMap=t.normalMap,this.normalMapType=t.normalMapType,this.normalScale.copy(t.normalScale),this.displacementMap=t.displacementMap,this.displacementScale=t.displacementScale,this.displacementBias=t.displacementBias,this.specularMap=t.specularMap,this.alphaMap=t.alphaMap,this.envMap=t.envMap,this.envMapRotation.copy(t.envMapRotation),this.combine=t.combine,this.reflectivity=t.reflectivity,this.refractionRatio=t.refractionRatio,this.wireframe=t.wireframe,this.wireframeLinewidth=t.wireframeLinewidth,this.wireframeLinecap=t.wireframeLinecap,this.wireframeLinejoin=t.wireframeLinejoin,this.flatShading=t.flatShading,this.fog=t.fog,this}}class Zo extends pe{constructor(t,e=1){super(),this.isLight=!0,this.type="Light",this.color=new Vt(t),this.intensity=e}dispose(){}copy(t,e){return super.copy(t,e),this.color.copy(t.color),this.intensity=t.intensity,this}toJSON(t){const e=super.toJSON(t);return e.object.color=this.color.getHex(),e.object.intensity=this.intensity,this.groundColor!==void 0&&(e.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(e.object.distance=this.distance),this.angle!==void 0&&(e.object.angle=this.angle),this.decay!==void 0&&(e.object.decay=this.decay),this.penumbra!==void 0&&(e.object.penumbra=this.penumbra),this.shadow!==void 0&&(e.object.shadow=this.shadow.toJSON()),this.target!==void 0&&(e.object.target=this.target.uuid),e}}class Sp extends Zo{constructor(t,e,n){super(t,n),this.isHemisphereLight=!0,this.type="HemisphereLight",this.position.copy(pe.DEFAULT_UP),this.updateMatrix(),this.groundColor=new Vt(e)}copy(t,e){return super.copy(t,e),this.groundColor.copy(t.groundColor),this}}const Jr=new re,fo=new H,po=new H;class yp{constructor(t){this.camera=t,this.intensity=1,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new qt(512,512),this.map=null,this.mapPass=null,this.matrix=new re,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new js,this._frameExtents=new qt(1,1),this._viewportCount=1,this._viewports=[new ae(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(t){const e=this.camera,n=this.matrix;fo.setFromMatrixPosition(t.matrixWorld),e.position.copy(fo),po.setFromMatrixPosition(t.target.matrixWorld),e.lookAt(po),e.updateMatrixWorld(),Jr.multiplyMatrices(e.projectionMatrix,e.matrixWorldInverse),this._frustum.setFromProjectionMatrix(Jr),n.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),n.multiply(Jr)}getViewport(t){return this._viewports[t]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(t){return this.camera=t.camera.clone(),this.intensity=t.intensity,this.bias=t.bias,this.radius=t.radius,this.mapSize.copy(t.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const t={};return this.intensity!==1&&(t.intensity=this.intensity),this.bias!==0&&(t.bias=this.bias),this.normalBias!==0&&(t.normalBias=this.normalBias),this.radius!==1&&(t.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(t.mapSize=this.mapSize.toArray()),t.camera=this.camera.toJSON(!1).object,delete t.camera.matrix,t}}class Ep extends yp{constructor(){super(new Go(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class Tp extends Zo{constructor(t,e){super(t,e),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(pe.DEFAULT_UP),this.updateMatrix(),this.target=new pe,this.shadow=new Ep}dispose(){this.shadow.dispose()}copy(t){return super.copy(t),this.target=t.target.clone(),this.shadow=t.shadow.clone(),this}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:ks}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=ks);const ue={sky:11125976,ground:5212732,berm:3815480,bermAccent:5920080,gate:14431557,gateBase:2763310,portal:7023242,portalGlow:11820287,player:9417940,shield:4868682,swordBlade:14211288,swordGuard:4013373,enemy:10101299,enemyHit:16747146,slash:16770720,impact:16764006},j={arenaRadius:28,playerRadius:.55,playerSpeed:8.5,playerHp:100,gateHp:500,gateSize:2.4,enemySize:1.1,enemySpeed:2.6,enemyHp:20,enemyContactDamage:9,enemyGateDamage:1.2,enemyContactCooldown:.8,enemyGateCooldown:1.2,enemyAttackRange:1.55,enemyTelegraph:.48,enemyBonk:.22,enemyRecover:.4,enemyKnockback:2.8,corpseLifetime:2.8,corpseBounce:.42,maxEnemies:300,waveCountdown:3,cameraDistance:3.2,cameraHeight:1.55,cameraLookHeight:1.05,mouseSensitivity:.0022,lightDamage:18,combo3Damage:28,comboWindow:.6,comboStepDur:[.3,.3,.42],lightRange:3.2,lightCooldown:.08,heavyDamage:42,heavyRange:3.4,heavyCooldown:.48,heavyDur:.36,pushDamage:26,pushRange:3,pushCooldown:.35,pushDur:.28,spinDamage:14,spinRevolutions:3,spinRange:3.4,spinCooldown:2.6,spinDur:1.15,slamDamage:55,slamRange:4.2,slamCooldown:3.2,slamWindup:.42,slamSlam:.18,slamRecover:.22,dodgeCooldown:.85,dodgeDuration:.28,dodgeSpeedMul:2.6,iFrameDuration:.35,jumpVelocity:7.2,gravity:22,playerKnockback:4.5,hitStop:.06,scorePerKill:12,scorePerSecondNear:6};function Ap(i){const t=4+i*i*3.2+i*5;return Math.min(j.maxEnemies,Math.floor(t))}function bp(i){const t=Math.max(0,Math.floor(i)),e=Math.floor(t/60),n=t%60;return`${e}:${n.toString().padStart(2,"0")}`}function wp(i){const t=new Set,e={dx:0,dy:0,buttons:0},n={x:0,y:0},r={light:!1,heavy:!1,push:!1,block:!1,dodge:!1,spin:!1,slam:!1,jump:!1,camera:!1},s=matchMedia("(pointer: coarse)").matches;let a=!1,o=!1,c=0,l=0;function h(){if(s&&(n.x!==0||n.y!==0))return;let b=0,w=0;(t.has("KeyA")||t.has("ArrowLeft"))&&(b-=1),(t.has("KeyD")||t.has("ArrowRight"))&&(b+=1),(t.has("KeyW")||t.has("ArrowUp"))&&(w-=1),(t.has("KeyS")||t.has("ArrowDown"))&&(w+=1);const P=Math.hypot(b,w)||1;n.x=b/P,n.y=w/P}function d(b){t.add(b.code),b.code==="KeyE"&&(r.heavy=!0),(b.code==="ShiftLeft"||b.code==="ShiftRight")&&(r.dodge=!0),b.code==="KeyQ"&&(r.spin=!0),b.code==="KeyF"&&(r.slam=!0),b.code==="KeyV"&&(r.camera=!0),b.code==="Space"&&(b.preventDefault(),r.jump=!0),h()}function f(b){t.delete(b.code),h()}function m(b){var w;e.buttons|=1<<b.button,b.button===2&&(r.block=!0),b.button===0&&(r.block||e.buttons&4||e.buttons&4?r.push=!0:r.light=!0),!a&&!s&&((w=i.requestPointerLock)==null||w.call(i))}function v(b){e.buttons&=~(1<<b.button),b.button===2&&(r.block=!1)}function x(b){a?(e.dx+=b.movementX,e.dy+=b.movementY):o&&(e.dx+=b.clientX-c,e.dy+=b.clientY-l,c=b.clientX,l=b.clientY)}function p(){a=document.pointerLockElement===i}function u(b){b.preventDefault()}window.addEventListener("keydown",d),window.addEventListener("keyup",f),i.addEventListener("mousedown",m),window.addEventListener("mouseup",v),window.addEventListener("mousemove",x),document.addEventListener("pointerlockchange",p),i.addEventListener("contextmenu",u);const T=document.getElementById("stick"),A=document.getElementById("stick-knob"),_=document.getElementById("touch");if(s&&_){let y=function(M){const R=T.getBoundingClientRect(),z=R.left+R.width/2,L=R.top+R.height/2;let G=M.clientX-z,K=M.clientY-L;const W=Math.hypot(G,K)||1,tt=Math.min(W,w);G=G/W*tt,K=K/W*tt,n.x=G/w,n.y=K/w,A&&(A.style.transform=`translate(${G}px, ${K}px)`)};var B=y;_.classList.remove("hidden");let b=null;const w=46;T==null||T.addEventListener("pointerdown",M=>{b=M.pointerId,T.setPointerCapture(M.pointerId),y(M)}),T==null||T.addEventListener("pointermove",M=>{M.pointerId===b&&y(M)});const P=M=>{M.pointerId===b&&(b=null,n.x=0,n.y=0,A&&(A.style.transform="translate(0,0)"))};T==null||T.addEventListener("pointerup",P),T==null||T.addEventListener("pointercancel",P),i.addEventListener("pointerdown",M=>{var R,z;(z=(R=M.target).closest)!=null&&z.call(R,".touch-actions, .stick, button, .overlay")||M.clientX<window.innerWidth*.45||(o=!0,c=M.clientX,l=M.clientY)}),window.addEventListener("pointerup",()=>{o=!1}),document.querySelectorAll(".tbtn").forEach(M=>{const R=M.dataset.act,z=G=>{G.preventDefault(),R==="block"?r.block=!0:R==="light"&&r.block?r.push=!0:R&&(r[R]=!0)},L=()=>{R==="block"&&(r.block=!1)};M.addEventListener("pointerdown",z),M.addEventListener("pointerup",L),M.addEventListener("pointercancel",L)})}return{move:n,actions:r,mouse:e,get pointerLocked(){return a},requestLock(){var b;s||(b=i.requestPointerLock)==null||b.call(i)},consumeMouseDelta(){const b=e.dx,w=e.dy;return e.dx=0,e.dy=0,{dx:b,dy:w}},consumeAction(b){return r[b]?(b==="block"||(r[b]=!1),!0):!1},isBlocking(){return r.block||!!(e.buttons&4)},dispose(){window.removeEventListener("keydown",d),window.removeEventListener("keyup",f),i.removeEventListener("mousedown",m),window.removeEventListener("mouseup",v),window.removeEventListener("mousemove",x),document.removeEventListener("pointerlockchange",p),i.removeEventListener("contextmenu",u)}}}function Rp(i){const t=new Xe;t.name="Arena",i.add(t);const e=new te(new ta(j.arenaRadius,64),new Re({color:ue.ground}));e.rotation.x=-Math.PI/2,e.receiveShadow=!1,t.add(e);const n=new te(new Ni(j.arenaRadius-.9,j.arenaRadius+1.4,64),new Re({color:ue.berm,side:Ne}));n.rotation.x=-Math.PI/2,n.position.y=.02,t.add(n);const r=new Re({color:ue.bermAccent});for(let v=0;v<10;v++){const x=v/10*Math.PI*2+.2,p=new te(new We(4.2,1.6,1.1),r);p.position.set(Math.cos(x)*(j.arenaRadius+.2),.8,Math.sin(x)*(j.arenaRadius+.2)),p.lookAt(0,.8,0),t.add(p)}const s=new te(new yr(10,24,16,0,Math.PI*2,0,Math.PI*.5),new Re({color:12105912}));s.position.set(-18,0,-6),t.add(s);const a=new Xe;a.position.set(0,0,-28+4.5),t.add(a);const o=new te(new We(3.2,.45,3.2),new Re({color:ue.gateBase}));o.position.y=.225,a.add(o);const c=new te(new We(j.gateSize,j.gateSize,j.gateSize),new Re({color:ue.gate,emissive:0,emissiveIntensity:0}));c.position.y=.45+j.gateSize/2,a.add(c);const l=new Xe;l.position.set(0,0,j.arenaRadius-3.5),t.add(l);const h=new te(new We(2.2,2.8,.6),new Re({color:ue.portal,emissive:ue.portalGlow,emissiveIntensity:.45}));h.position.y=1.5,l.add(h);const d=new te(new ea(1.5,.12,8,24),new Ui({color:ue.portalGlow}));d.position.y=1.5,l.add(d);const f=new Sp(14215423,3820072,.85);i.add(f);const m=new Tp(16773848,.9);return m.position.set(12,22,8),i.add(m),i.background=new Vt(ue.sky),i.fog=new Qs(ue.sky,42,70),{group:t,gateGroup:a,gateMesh:c,portalGroup:l,portalPosition:l.position.clone(),gatePosition:a.position.clone(),clampToArena(v,x=j.playerRadius){const p=j.arenaRadius-x-.4,u=Math.hypot(v.x,v.z);if(u>p){const T=p/u;v.x*=T,v.z*=T}}}}const De={x:.65,y:.9,z:-.15},Ie={x:-.55,y:.85,z:-.1},ke=-1;function Cp(i,t=new H(0,0,-4)){const e=new Xe;e.position.copy(t),i.add(e);const n=new te(new yr(j.playerRadius,24,18),new Re({color:ue.player,emissive:0}));n.position.y=j.playerRadius,e.add(n);const r=new Xe;r.position.y=.9,e.add(r);const s=new te(new Li(.55,.55,.1,22),new Re({color:ue.shield,emissive:0,emissiveIntensity:0}));s.rotation.set(0,0,Math.PI/2),s.position.set(Ie.x,Ie.y-.9,Ie.z),r.add(s);const a=new Xe;a.position.set(De.x,De.y-.9,De.z),r.add(a);const o=new te(new We(.12,1.35,.06),new Re({color:ue.swordBlade}));o.position.y=.55,a.add(o);const c=new te(new Li(.22,.22,.08,12),new Re({color:ue.swordGuard}));c.rotation.z=Math.PI/2,a.add(c);const l=new te(new Li(.05,.05,.35,8),new Re({color:5913122}));l.position.y=-.18,a.add(l);const h=1.15,d=Math.PI*.92,f=d/2,m=new Xe;m.position.set(0,.12,0),r.add(m);const v=new Ni(h-.1,h+.08,32,1,Math.PI/2-f,d),x=new Ui({color:ue.slash,transparent:!0,opacity:0,side:Ne,depthWrite:!1}),p=new te(v,x);p.rotation.x=-Math.PI/2,p.position.set(0,.12,0),r.add(p);const u=new Ni(.4,.75,32),T=new Ui({color:ue.impact,transparent:!0,opacity:0,side:Ne,depthWrite:!1}),A=new te(u,T);A.rotation.x=-Math.PI/2,A.position.y=.06,e.add(A);const _={yaw:Math.PI,pitch:.12,hp:j.playerHp,vy:0,grounded:!0,blocking:!1,iFrames:0,dodgeTimer:0,hitStop:0,knockX:0,knockZ:0,anim:null,comboStep:0,comboTimer:0,cooldowns:{light:0,heavy:0,push:0,spin:0,slam:0,dodge:0},alive:!0,pendingHits:[],cameraMode:0},B=new H,b=new H,w=new H;function P(){return B.set(-Math.sin(_.yaw),0,-Math.cos(_.yaw)),B}function y(){return b.set(Math.cos(_.yaw),0,-Math.sin(_.yaw)),b}function M(){R(),s.position.set(Ie.x,Ie.y-.9,Ie.z),s.rotation.set(0,0,Math.PI/2),s.scale.set(1,1,1),r.rotation.set(0,0,0),m.rotation.set(0,0,0),n.scale.set(1,1,1)}function R(){a.parent!==r&&(m.remove(a),r.add(a)),a.position.set(De.x,De.y-.9,De.z),a.rotation.set(0,0,0),a.scale.set(1,1,1)}function z(){a.parent!==m&&(r.remove(a),m.add(a)),a.position.set(0,0,-h),a.rotation.set(Math.PI/2,Math.PI/2,0),a.scale.set(1,1,1)}function L(D){_.anim={...D,t:0},_.pendingHits=(D.hits||[]).map(et=>({...et,fired:!1}))}function G(D){return 1-(1-D)**3}function K(D){return D*D*D}function W(D){const et=Math.sin(performance.now()*.006)*.03;if(n.position.y=j.playerRadius+et,e.rotation.y=_.yaw,T.opacity>0){T.opacity=Math.max(0,T.opacity-D*2.2);const vt=1+(1-T.opacity)*2.8;A.scale.set(vt,vt,vt)}if(!_.anim){x.opacity=Math.max(0,x.opacity-D*4),p.visible=x.opacity>.02,m.rotation.y=0,_.blocking?(s.position.set(0,.22,1.1*ke),s.rotation.set(Math.PI/2,0,0),s.scale.set(1.4,1.4,1.4),s.material.emissive.setHex(6986956),s.material.emissiveIntensity=.45,a.position.set(.75,-.1,.05*ke),a.rotation.set(.4,0,.7)):(s.material.emissive.setHex(0),s.material.emissiveIntensity=0,s.scale.set(1,1,1),s.position.set(Ie.x,Ie.y-.9,Ie.z),s.rotation.set(0,0,Math.PI/2),a.position.set(De.x,De.y-.9,De.z),a.rotation.set(0,0,0));return}_.anim.t+=D;const it=Math.min(1,_.anim.t/_.anim.dur),ut=_.anim.type;if(ut==="slashL"||ut==="slashR"){const vt=ut==="slashL",Rt=Math.sin(it*Math.PI);z();const X=vt?-f:f,J=vt?f:-f;m.rotation.y=Pi.lerp(X,J,G(it)),p.visible=!0,x.opacity=Rt*.92,p.scale.setScalar(.94+Rt*.08),s.position.set(-.45,0,.1*ke),s.rotation.set(0,0,Math.PI/2)}else if(ut==="slashSpin"){const vt=it*Math.PI*2;z(),r.rotation.y=vt,m.rotation.y=0,p.visible=!0,x.opacity=.7*(1-it*.5),s.position.set(-.85,.05,.05*ke),s.rotation.set(0,0,Math.PI/2)}else if(ut==="spin"){R();const vt=j.spinRevolutions,Rt=it*Math.PI*2*vt;r.rotation.y=Rt,a.position.set(1.25,.05,0),a.rotation.set(0,0,-Math.PI/2),s.position.set(-1.25,.05,0),s.rotation.set(Math.PI/2,0,Math.PI/2),x.opacity=.55,p.visible=!0,n.scale.setScalar(1+Math.sin(Rt*2)*.04)}else if(ut==="slam"){R();const vt=j.slamWindup,Rt=j.slamSlam,X=_.anim.t;if(X<vt){const J=G(X/vt);a.position.set(.25,.2+J*1.1,.1*ke),a.rotation.set(-1.4*J,0,.2),s.position.set(-.25,.15+J*1,.05*ke),s.rotation.set(-.4*J,0,Math.PI/2),n.scale.set(1,1+J*.12,1)}else if(X<vt+Rt){const J=K((X-vt)/Rt);a.position.set(.2,1.3-J*1.5,.35*ke),a.rotation.set(-1.4+J*2.2,0,0),s.position.set(-.2,1.15-J*1.35,.3*ke),s.rotation.set(-.4+J*1.2,0,Math.PI/2),n.scale.set(1+J*.2,1.12-J*.25,1+J*.2),J>.85&&T.opacity<.1&&(T.opacity=.95,A.scale.set(1,1,1))}else{const J=(X-vt-Rt)/j.slamRecover;a.position.lerp(new H(De.x,De.y-.9,De.z),J),s.position.lerp(new H(Ie.x,Ie.y-.9,Ie.z),J),n.scale.setScalar(1)}x.opacity=0}else if(ut==="heavy"||ut==="push"){const vt=Math.sin(it*Math.PI);if(ut==="push")R(),s.position.set(0,.15,(.4+vt*.9)*ke),s.rotation.set(Math.PI/2,0,0),s.scale.set(1.3,1.3,1.3),a.position.set(.6,0,.1*ke);else{z();const Rt=-f*.55,X=f*.65;m.rotation.y=Pi.lerp(Rt,X,G(it)),p.visible=!0,x.opacity=vt*.85,s.position.set(-.4,0,.2*ke)}}else ut==="dodge"&&(n.material.transparent=!0,n.material.opacity=.4+.6*Math.abs(Math.sin(it*Math.PI*4)));if(it>=1){const vt=ut==="dodge";_.anim=null,r.rotation.set(0,0,0),M(),x.opacity=0,p.visible=!1,m.rotation.y=0,vt&&(n.material.transparent=!1,n.material.opacity=1)}}function tt(){if(!_.anim)return[];const D=Math.min(1,_.anim.t/_.anim.dur),et=[];for(const it of _.pendingHits)!it.fired&&D>=it.at&&(it.fired=!0,et.push(it));return et}return{root:e,body:n,sword:a,shield:s,state:_,getForward:P,getRight:y,get position(){return e.position},applyLook(D,et){_.yaw-=D*j.mouseSensitivity,_.pitch-=et*j.mouseSensitivity,_.pitch=Pi.clamp(_.pitch,-.35,.55)},cycleCamera(){return _.cameraMode=(_.cameraMode+1)%3,_.cameraMode},tryLight(){if(!_.alive||_.dodgeTimer>0||_.cooldowns.light>0||_.anim&&(_.anim.type==="spin"||_.anim.type==="slam"))return!1;_.comboTimer<=0&&(_.comboStep=0);const D=_.comboStep%3,et=j.comboStepDur[D];return _.cooldowns.light=j.lightCooldown,_.comboTimer=j.comboWindow,_.comboStep=D+1,D===0?L({type:"slashL",dur:et,hits:[{kind:"arc",damage:j.lightDamage,range:j.lightRange,arc:-.1,at:.4}]}):D===1?L({type:"slashR",dur:et,hits:[{kind:"arc",damage:j.lightDamage,range:j.lightRange,arc:-.1,at:.4}]}):(L({type:"slashSpin",dur:et,hits:[{kind:"radius",damage:j.combo3Damage,range:j.lightRange*.95,at:.35},{kind:"radius",damage:j.combo3Damage*.6,range:j.lightRange*.95,at:.7}]}),_.comboStep=0,_.comboTimer=0),!0},tryHeavy(){return!_.alive||_.dodgeTimer>0||_.cooldowns.heavy>0||_.anim&&(_.anim.type==="spin"||_.anim.type==="slam")?!1:(_.cooldowns.heavy=j.heavyCooldown,_.comboStep=0,_.comboTimer=0,L({type:"heavy",dur:j.heavyDur,hits:[{kind:"arc",damage:j.heavyDamage,range:j.heavyRange,arc:-.15,at:.45}]}),!0)},tryPush(){return!_.alive||_.cooldowns.push>0||_.anim&&(_.anim.type==="spin"||_.anim.type==="slam")?!1:(_.cooldowns.push=j.pushCooldown,L({type:"push",dur:j.pushDur,hits:[{kind:"arc",damage:j.pushDamage,range:j.pushRange,arc:-.2,at:.35}]}),!0)},trySpin(){if(!_.alive||_.dodgeTimer>0||_.cooldowns.spin>0)return!1;_.cooldowns.spin=j.spinCooldown,_.comboStep=0,_.comboTimer=0;const D=[];for(let et=0;et<j.spinRevolutions;et++)D.push({kind:"radius",damage:j.spinDamage,range:j.spinRange,at:(et+.45)/j.spinRevolutions});return L({type:"spin",dur:j.spinDur,hits:D}),!0},trySlam(){if(!_.alive||_.dodgeTimer>0||_.cooldowns.slam>0)return!1;_.cooldowns.slam=j.slamCooldown,_.comboStep=0,_.comboTimer=0;const D=j.slamWindup+j.slamSlam+j.slamRecover,et=j.slamWindup/D+j.slamSlam*.9/D;return L({type:"slam",dur:D,hits:[{kind:"radius",damage:j.slamDamage,range:j.slamRange,at:et}]}),!0},tryDodge(){return!_.alive||_.cooldowns.dodge>0||_.dodgeTimer>0?!1:(_.cooldowns.dodge=j.dodgeCooldown,_.dodgeTimer=j.dodgeDuration,_.iFrames=j.iFrameDuration,L({type:"dodge",dur:j.dodgeDuration,hits:[]}),!0)},tryJump(){return!_.alive||!_.grounded?!1:(_.vy=j.jumpVelocity,_.grounded=!1,!0)},takeDamage(D,et=0,it=0){if(!_.alive||_.iFrames>0)return 0;let ut=D;_.blocking&&(ut*=.28),_.hp=Math.max(0,_.hp-ut),_.iFrames=_.blocking?.15:.4,_.hitStop=j.hitStop;const vt=e.position.x-et,Rt=e.position.z-it,X=Math.hypot(vt,Rt)||1,J=_.blocking?j.playerKnockback*.35:j.playerKnockback;return _.knockX=vt/X*J,_.knockZ=Rt/X*J,n.material.emissiveIntensity=.7,n.material.emissive.setHex(16720418),setTimeout(()=>{n.material.emissiveIntensity=0},90),_.hp<=0&&(_.alive=!1),ut},consumeHits:tt,update(D,et,it){var X,J,Et;if(!_.alive)return;if(_.hitStop>0){_.hitStop=Math.max(0,_.hitStop-D),_.iFrames=Math.max(0,_.iFrames-D),W(D*.2);return}for(const ht of Object.keys(_.cooldowns))_.cooldowns[ht]=Math.max(0,_.cooldowns[ht]-D);_.iFrames=Math.max(0,_.iFrames-D),_.dodgeTimer=Math.max(0,_.dodgeTimer-D),_.comboTimer=Math.max(0,_.comboTimer-D),_.comboTimer<=0&&(_.comboStep=0),_.blocking=et.isBlocking(),_.blocking&&_.anim&&(_.anim.type==="slashL"||_.anim.type==="slashR"||_.anim.type==="slashSpin"||_.anim.type==="heavy")&&(_.anim=null,_.pendingHits=[],r.rotation.set(0,0,0),m.rotation.set(0,0,0),M(),x.opacity=0,p.visible=!1),_.blocking&&(((X=_.anim)==null?void 0:X.type)==="spin"||((J=_.anim)==null?void 0:J.type)==="slam"||((Et=_.anim)==null?void 0:Et.type)==="dodge")&&(_.blocking=!1);const ut=P(),vt=y();w.set(0,0,0),w.addScaledVector(vt,et.move.x),w.addScaledVector(ut,-et.move.y),w.lengthSq()>1&&w.normalize();let Rt=j.playerSpeed;_.dodgeTimer>0&&(Rt*=j.dodgeSpeedMul),_.blocking&&(Rt*=.55),_.anim&&(_.anim.type==="slam"||_.anim.type==="heavy"||_.anim.type==="push")&&(Rt*=.35),_.anim&&_.anim.type==="spin"&&(Rt*=.7),e.position.x+=w.x*Rt*D+_.knockX*D,e.position.z+=w.z*Rt*D+_.knockZ*D,_.knockX*=Math.max(0,1-D*8),_.knockZ*=Math.max(0,1-D*8),_.vy-=j.gravity*D,e.position.y+=_.vy*D,e.position.y<=0&&(e.position.y=0,_.vy=0,_.grounded=!0),it(e.position,j.playerRadius),W(D)},facingDir(){return P().clone()}}}function Pp(i,t,e){const n=t.state.yaw,r=t.state.pitch,s=t.state.cameraMode;let a=j.cameraDistance,o=j.cameraHeight,c=j.cameraLookHeight;s===1?(a=5.2,o=3.4,c=.6):s===2&&(a=2.2,o=1.25,c=1.15);const l=new H(t.position.x,t.position.y+c,t.position.z),h=new H(Math.sin(n)*a*Math.cos(r),o+Math.sin(r)*a,Math.cos(n)*a*Math.cos(r)),d=l.clone().add(h);i.position.lerp(d,1-Math.pow(.001,e)),i.lookAt(l)}const Ai=0,Qr=1,mo=2,go=3,Pn=1,_o=2;function Lp(i){const t=j.maxEnemies,e=new We(j.enemySize,j.enemySize,j.enemySize),n=new Re({color:ue.enemy}),r=new Mp(e,n,t);r.instanceMatrix.setUsage(ga),r.count=0,i.add(r);const s=new pe,a=new Uint8Array(t),o=new Float32Array(t),c=new Float32Array(t),l=new Float32Array(t),h=new Float32Array(t),d=new Float32Array(t),f=new Float32Array(t),m=new Uint8Array(t),v=new Float32Array(t),x=new Float32Array(t),p=new Float32Array(t),u=new Float32Array(t),T=new Float32Array(t),A=new Float32Array(t),_=new Float32Array(t),B=new Float32Array(t),b=new Float32Array(t),w=new Float32Array(t),P=new Float32Array(t),y=new Float32Array(t),M=new Float32Array(t),R=new Float32Array(t),z=new Float32Array(t),L=new Float32Array(t),G=new Float32Array(t*3);r.instanceColor=new Hs(G,3),r.instanceColor.setUsage(ga);const K=new Vt(ue.enemy),W=new Vt(ue.enemyHit),tt=new Vt(5903648),D=new Vt;let et=0,it=[];for(let O=t-1;O>=0;O--)it.push(O);function ut(){r.instanceMatrix.needsUpdate=!0,r.instanceColor.needsUpdate=!0}function vt(O,dt){G[O*3]=dt.r,G[O*3+1]=dt.g,G[O*3+2]=dt.b}function Rt(O,dt={}){const ot=dt.bounce??0,lt=dt.lean??0,Ct=dt.stretchY??1,gt=dt.stretchXZ??1,E=x[O],g=A[O];s.position.set(o[O],c[O]+ot,l[O]);const F=d[O],Z=(1+F*.22)*gt*(1+g*.35),$=(1+F*.1)*Ct*(1-g*.45);s.scale.set(Z,Math.max(.35,$),Z);const Y=dt.wobbleRoll??0;s.rotation.set(lt+g*.4+M[O],E+R[O],Y+z[O]),s.updateMatrix(),r.setMatrixAt(O,s.matrix)}function X(O){s.position.set(0,-10,0),s.scale.setScalar(0),s.rotation.set(0,0,0),s.updateMatrix(),r.setMatrixAt(O,s.matrix),w[O]=0,P[O]=0,y[O]=0,M[O]=0,R[O]=0,z[O]=0,_[O]=0,B[O]=0,b[O]=0,L[O]=0}function J(O){a[O]=0,X(O),it.push(O),ut()}function Et(O,dt){if(it.length===0)return-1;const ot=it.pop();return a[ot]=Pn,o[ot]=O,c[ot]=j.enemySize/2,l[ot]=dt,h[ot]=j.enemyHp,d[ot]=0,f[ot]=0,m[ot]=Ai,v[ot]=Math.random()*.4,x[ot]=Math.random()*Math.PI*2,p[ot]=Math.random()*Math.PI*2,u[ot]=0,T[ot]=0,A[ot]=0,_[ot]=0,B[ot]=0,b[ot]=0,w[ot]=0,P[ot]=0,y[ot]=0,M[ot]=0,R[ot]=0,z[ot]=0,L[ot]=0,vt(ot,K),Rt(ot),et+=1,r.count=t,ut(),ot}function ht(O,dt,ot){if(a[O]!==Pn)return;a[O]=_o,et-=1;let lt=o[O]-dt,Ct=l[O]-ot,gt=Math.hypot(lt,Ct);gt<.01&&(lt=Math.sin(x[O]+Math.PI),Ct=Math.cos(x[O]+Math.PI),gt=1);const E=lt/gt,g=Ct/gt;_[O]=E*(4.5+Math.random()*2.5)+u[O],b[O]=g*(4.5+Math.random()*2.5)+T[O],B[O]=4.2+Math.random()*2.8,w[O]=(Math.random()-.5)*10,P[O]=(Math.random()-.5)*10,y[O]=(Math.random()-.5)*10,L[O]=j.corpseLifetime,A[O]=0,d[O]=0,u[O]=0,T[O]=0,vt(O,tt),ut()}function Lt(O,dt,ot){const lt=new H().subVectors(ot,dt).normalize(),Ct=new H(-lt.z,0,lt.x);let gt=0,E=0;for(;gt<O;){const g=Math.min(O-gt,6+E*4),F=2.2+E*1.7;for(let Z=0;Z<g;Z++){const $=Z/g*Math.PI*2+E*.35,Y=dt.x+Math.cos($)*F*.65+Ct.x*Math.sin($)*F,Mt=dt.z+lt.z*(1.5+E*.4)+Math.sin($)*F*.75,at=j.arenaRadius-2,ct=Math.hypot(Y,Mt),Ut=ct>at?Y/ct*at:Y,rt=ct>at?Mt/ct*at:Mt;Et(Ut,rt)>=0&&(gt+=1)}if(E+=1,E>40)break}return gt}function Nt(){for(let O=0;O<t;O++)a[O]&&X(O),a[O]=0;et=0,it=[];for(let O=t-1;O>=0;O--)it.push(O);ut()}function Ht(O,dt,ot=null,lt=null){if(a[O]!==Pn)return!1;h[O]-=dt,d[O]=1,A[O]=1,D.copy(K).lerp(W,.85),vt(O,D);const Ct=ot??o[O],gt=lt??l[O];let E=o[O]-Ct,g=l[O]-gt,F=Math.hypot(E,g);return F<.01&&(E=Math.sin(x[O]+Math.PI),g=Math.cos(x[O]+Math.PI),F=1),u[O]=E/F*j.enemyKnockback,T[O]=g/F*j.enemyKnockback,m[O]===Qr&&(m[O]=Ai,v[O]=0),h[O]<=0?(ht(O,Ct,gt),!0):!1}function ee(O,dt){L[O]-=dt,B[O]-=j.gravity*dt,o[O]+=_[O]*dt,c[O]+=B[O]*dt,l[O]+=b[O]*dt,M[O]+=w[O]*dt,R[O]+=P[O]*dt,z[O]+=y[O]*dt;const ot=j.enemySize/2;c[O]<=ot&&(c[O]=ot,B[O]<-.5?(B[O]=-B[O]*j.corpseBounce,_[O]*=.72,b[O]*=.72,w[O]*=.65,P[O]*=.65,y[O]*=.65):(B[O]=0,_[O]*=Math.max(0,1-dt*2.2),b[O]*=Math.max(0,1-dt*2.2)));const lt=j.arenaRadius-1,Ct=Math.hypot(o[O],l[O]);Ct>lt&&(o[O]=o[O]/Ct*lt,l[O]=l[O]/Ct*lt,_[O]*=-.35,b[O]*=-.35),Rt(O),L[O]<=0&&J(O)}function Gt(O,dt,ot,lt,Ct){let gt=!1;const E=performance.now()*.001;for(let g=0;g<t;g++){if(a[g]===_o){ee(g,O),gt=!0;continue}if(a[g]!==Pn)continue;f[g]=Math.max(0,f[g]-O),v[g]+=O,A[g]>0&&(A[g]=Math.max(0,A[g]-O*4)),(u[g]!==0||T[g]!==0)&&(o[g]+=u[g]*O,l[g]+=T[g]*O,u[g]*=Math.max(0,1-O*7),T[g]*=Math.max(0,1-O*7),Math.abs(u[g])<.05&&(u[g]=0),Math.abs(T[g])<.05&&(T[g]=0)),d[g]>0&&(d[g]=Math.max(0,d[g]-O*3),D.copy(K).lerp(W,d[g]),vt(g,D),gt=!0);const F=ot.x-o[g],Z=ot.z-l[g],$=Math.hypot(F,Z)||1,Y=dt.x-o[g],Mt=dt.z-l[g],at=Math.hypot(Y,Mt)||1;let ct=F/$,Ut=Z/$;if(at<11){const nt=Pi.clamp(1.15-at/11,.25,.85);ct=ct*(1-nt)+Y/at*nt,Ut=Ut*(1-nt)+Mt/at*nt;const yt=Math.hypot(ct,Ut)||1;ct/=yt,Ut/=yt}let rt=0,St=0;for(let nt=0;nt<8;nt++){const yt=(g+1+nt*37)%t;if(a[yt]!==Pn||yt===g)continue;const Jt=o[g]-o[yt],ce=l[g]-l[yt],Wt=Jt*Jt+ce*ce;if(Wt<1.6&&Wt>1e-4){const Se=1/Wt;rt+=Jt*Se,St+=ce*Se}}ct+=rt*.15,Ut+=St*.15;const Pt=Math.hypot(ct,Ut)||1;ct/=Pt,Ut/=Pt;let xt=Math.atan2(ct,Ut)-x[g];for(;xt>Math.PI;)xt-=Math.PI*2;for(;xt<-Math.PI;)xt+=Math.PI*2;x[g]+=xt*Math.min(1,O*6);let kt=0,It=0,Yt=1,C=1,ft=0,q=!1;if(m[g]===Ai&&(at<j.enemyAttackRange&&f[g]<=0?(m[g]=Qr,v[g]=0):q=!0),m[g]===Qr){const nt=Math.min(1,v[g]/j.enemyTelegraph),yt=nt*nt;It=.95*yt,Yt=1-yt*.22,C=1+yt*.28,kt=yt*.15,x[g]=Math.atan2(Y,Mt),v[g]>=j.enemyTelegraph&&(m[g]=mo,v[g]=0)}else if(m[g]===mo){const nt=Math.min(1,v[g]/j.enemyBonk);It=.95-nt*1.7,Yt=.78+nt*.4,C=1.28-nt*.35,kt=(1-nt)*.12;const yt=7.5*(1-nt);o[g]+=Math.sin(x[g])*yt*O,l[g]+=Math.cos(x[g])*yt*O,nt>.35&&nt<.85&&f[g]<=0&&Math.hypot(dt.x-o[g],dt.z-l[g])<j.playerRadius+j.enemySize*.7&&(f[g]=j.enemyContactCooldown,lt==null||lt(g)),v[g]>=j.enemyBonk&&(m[g]=go,v[g]=0)}else if(m[g]===go){const nt=Math.min(1,v[g]/j.enemyRecover);It=Pi.lerp(-.35,0,nt),Yt=1,C=1,v[g]>=j.enemyRecover&&(m[g]=Ai,v[g]=0,f[g]=j.enemyContactCooldown*.5)}if(q){const nt=j.enemySpeed*(.9+g%5*.04);o[g]+=ct*nt*O,l[g]+=Ut*nt*O;const yt=E*7.5+p[g];kt=Math.abs(Math.sin(yt))*.22,Yt=1+Math.sin(yt)*.12,C=1-Math.sin(yt)*.1,ft=Math.sin(yt*.5)*.18,It=Math.sin(yt)*.08}c[g]=j.enemySize/2;const Q=j.arenaRadius-1,mt=Math.hypot(o[g],l[g]);mt>Q&&(o[g]=o[g]/mt*Q,l[g]=l[g]/mt*Q),Rt(g,{bounce:kt,lean:It,stretchY:Yt,stretchXZ:C,wobbleRoll:ft}),gt=!0,$<j.gateSize*.85&&f[g]<=0&&m[g]===Ai&&(f[g]=j.enemyGateCooldown,Ct==null||Ct(g))}gt&&ut()}function se(O,dt,ot,lt=.35){const Ct=[],gt=O.x,E=O.z;for(let g=0;g<t;g++){if(a[g]!==Pn)continue;const F=o[g]-gt,Z=l[g]-E,$=Math.hypot(F,Z);if($>ot||$<.01)continue;const Y=F/$,Mt=Z/$;Y*dt.x+Mt*dt.z>=lt&&Ct.push({i:g,dist:$})}return Ct.sort((g,F)=>g.dist-F.dist),Ct}function N(O,dt){const ot=[];for(let lt=0;lt<t;lt++){if(a[lt]!==Pn)continue;const Ct=Math.hypot(o[lt]-O.x,l[lt]-O.z);Ct<=dt&&ot.push({i:lt,dist:Ct})}return ot}return{mesh:r,get aliveCount(){return et},spawnWave:Lt,clear:Nt,damage:Ht,update:Gt,queryHits:se,queryRadius:N,getPosition(O){return{x:o[O],y:c[O],z:l[O]}}}}function Dp(i,t,e){let n=0;function r(f,m){let v=0;const x=i.position.x,p=i.position.z;for(const u of f)t.damage(u.i,m,x,p)&&(v+=1);return f.length&&(n=Math.min(.4,n+.05+f.length*.012),e==null||e.hit(),i.state.hitStop=Math.max(i.state.hitStop,j.hitStop)),v}function s(f){if(f.kind==="radius"){const x=t.queryRadius(i.position,f.range);return r(x,f.damage)}const m=i.facingDir(),v=t.queryHits(i.position,m,f.range,f.arc??-.05);return r(v,f.damage)}function a(){i.tryLight()&&(e==null||e.slash())}function o(){i.tryHeavy()&&(e==null||e.slash())}function c(){i.tryPush()&&(e==null||e.push())}function l(){i.trySpin()&&(e==null||e.spin())}function h(){i.trySlam()&&(e==null||e.slam())}function d(f){n=Math.max(0,n-f*1.8);let m=0;const v=i.consumeHits();for(const x of v)m+=s(x),x.kind==="radius"&&x.damage>=j.slamDamage*.9&&(n=Math.min(.55,n+.22),e==null||e.slam());return m}return{light:a,heavy:o,push:c,spin:l,slam:h,update:d,get shake(){return n},addShake(f){n=Math.min(.6,n+f)}}}function Ip(i,t){let e=0,n="idle",r=0,s=0,a=0,o={};function c(v,x){o[v]=x}function l(v,x){var p;(p=o[v])==null||p.call(o,x)}function h(){e=0,a=0,i.clear(),d()}function d(){e+=1,n="countdown",r=j.waveCountdown,s=Math.ceil(r),l("countdown",{wave:e,value:s})}function f(){const v=Ap(e);i.spawnWave(v,t.portalPosition,t.gatePosition),n="fighting",l("fight",{wave:e,count:v})}function m(v){if(n==="countdown"){r-=v;const x=Math.max(0,Math.ceil(r));x!==s&&(s=x,l("countdown",{wave:e,value:s||"FIGHT!"})),r<=0&&f();return}if(n==="fighting"){i.aliveCount===0&&(a=e,n="between",r=1.4,l("cleared",{wave:e}));return}n==="between"&&(r-=v,r<=0&&d())}return{on:c,startRun:h,update:m,get wave(){return e},get phase(){return n},get wavesCleared(){return a},get countdownValue(){return s}}}function Up(){const i={hud:document.getElementById("hud"),menu:document.getElementById("menu"),gameover:document.getElementById("gameover"),gateText:document.getElementById("gate-text"),gateFill:document.getElementById("gate-fill"),hpText:document.getElementById("hp-text"),hpFill:document.getElementById("hp-fill"),score:document.getElementById("stat-score"),wave:document.getElementById("stat-wave"),kills:document.getElementById("stat-kills"),time:document.getElementById("stat-time"),alive:document.getElementById("stat-alive"),callout:document.getElementById("wave-callout"),waveTitle:document.getElementById("wave-title"),waveCount:document.getElementById("wave-count"),hint:document.getElementById("hint"),goTitle:document.getElementById("go-title"),goFlavor:document.getElementById("go-flavor"),goScore:document.getElementById("go-score"),goKills:document.getElementById("go-kills"),goWaves:document.getElementById("go-waves"),goTime:document.getElementById("go-time"),goBest:document.getElementById("go-best")};function t(){i.menu.classList.remove("hidden"),i.gameover.classList.add("hidden"),i.hud.classList.add("hidden")}function e(){i.menu.classList.add("hidden"),i.gameover.classList.add("hidden"),i.hud.classList.remove("hidden")}function n({reason:c,score:l,kills:h,waves:d,time:f,best:m}){i.gameover.classList.remove("hidden"),i.goTitle.textContent="Game Over",i.goFlavor.textContent=c==="gate"?"The gate was breached.":"You fell in battle.",i.goScore.textContent=String(Math.floor(l)),i.goKills.textContent=String(h),i.goWaves.textContent=String(d),i.goTime.textContent=`${Math.floor(f)}s`,i.goBest.textContent=String(Math.floor(m))}function r(c){const l=Math.max(0,c.gateHp/c.gateMax),h=Math.max(0,c.hp/c.hpMax);i.gateText.textContent=`${Math.ceil(c.gateHp)} / ${c.gateMax}`,i.hpText.textContent=`${Math.ceil(c.hp)} / ${c.hpMax}`,i.gateFill.style.transform=`scaleX(${l})`,i.hpFill.style.transform=`scaleX(${h})`,i.score.textContent=String(Math.floor(c.score)),i.wave.textContent=String(c.wave),i.kills.textContent=String(c.kills),i.time.textContent=bp(c.time),i.alive.textContent=String(c.alive)}function s(c,l){i.callout.classList.remove("hidden"),i.waveTitle.textContent=`WAVE ${c}`,i.waveCount.textContent=String(l)}function a(){i.callout.classList.add("hidden")}function o(c){var l;(l=i.hint)==null||l.classList.toggle("hidden",!c)}return{showMenu:t,showHud:e,showGameOver:n,update:r,showCallout:s,hideCallout:a,setHintVisible:o,els:i}}function Np(){let i=null,t=null;function e(){if(i)return i;const s=window.AudioContext||window.webkitAudioContext;return s?(i=new s,t=i.createGain(),t.gain.value=.22,t.connect(i.destination),i):null}function n(s,a,o="square",c=.2,l=0){const h=e();if(!h)return;h.state==="suspended"&&h.resume();const d=h.currentTime,f=h.createOscillator(),m=h.createGain();f.type=o,f.frequency.setValueAtTime(s,d),l&&f.frequency.exponentialRampToValueAtTime(Math.max(40,s+l),d+a),m.gain.setValueAtTime(c,d),m.gain.exponentialRampToValueAtTime(.001,d+a),f.connect(m),m.connect(t),f.start(d),f.stop(d+a+.02)}function r(s,a=.15,o=800){const c=e();if(!c)return;c.state==="suspended"&&c.resume();const l=c.currentTime,h=Math.floor(c.sampleRate*s),d=c.createBuffer(1,h,c.sampleRate),f=d.getChannelData(0);for(let p=0;p<h;p++)f[p]=Math.random()*2-1;const m=c.createBufferSource();m.buffer=d;const v=c.createBiquadFilter();v.type="bandpass",v.frequency.value=o,v.Q.value=.7;const x=c.createGain();x.gain.setValueAtTime(a,l),x.gain.exponentialRampToValueAtTime(.001,l+s),m.connect(v),v.connect(x),x.connect(t),m.start(l)}return{unlock(){var s,a;(a=(s=e())==null?void 0:s.resume)==null||a.call(s)},slash(){r(.08,.12,1800),n(420+Math.random()*80,.07,"sawtooth",.08,-180)},spin(){n(220,.12,"triangle",.1,120),r(.1,.1,600)},slam(){n(90,.18,"sine",.25,-40),r(.15,.2,200)},block(){n(160,.06,"square",.1),r(.05,.08,400)},push(){n(140,.1,"sawtooth",.12,-60),r(.08,.14,500)},hit(){n(300+Math.random()*40,.05,"square",.1,-100),r(.06,.12,900)},hurt(){n(180,.12,"sawtooth",.14,-80)},gateHit(){n(70,.1,"sine",.16,-20)},dodge(){n(520,.05,"sine",.06,80)}}}const vo="threejs-horde-best";function Fp(i){const t=new gp({canvas:i,antialias:!0,powerPreference:"high-performance"});t.setPixelRatio(Math.min(window.devicePixelRatio,2)),t.setSize(window.innerWidth,window.innerHeight),t.outputColorSpace=we;const e=new _p,n=new Ue(72,window.innerWidth/window.innerHeight,.1,120),r=Rp(e),s=Cp(e,new H(0,0,-4)),a=Lp(e),o=Np(),c=Dp(s,a,o),l=Ip(a,r),h=wp(i),d=Up();let f="menu",m=j.gateHp,v=0,x=0,p=0,u=Number(localStorage.getItem(vo)||0),T=0,A=performance.now(),_=!1;l.on("countdown",({wave:z,value:L})=>{d.showCallout(z,L)}),l.on("fight",()=>{d.hideCallout()}),l.on("cleared",()=>{v+=40});function B(){const z=window.innerWidth,L=window.innerHeight;n.aspect=z/L,n.updateProjectionMatrix(),t.setSize(z,L)}window.addEventListener("resize",B);function b(){a.clear(),s.state.hp=j.playerHp,s.state.alive=!0,s.state.iFrames=0,s.state.vy=0,s.position.set(0,0,-4),s.state.yaw=Math.PI,s.state.pitch=.12,m=j.gateHp,v=0,x=0,p=0,r.gateMesh.material.color.setHex(14431557),l.startRun()}function w(){o.unlock(),b(),f="playing",d.showHud(),d.setHintVisible(!matchMedia("(pointer: coarse)").matches),h.requestLock()}function P(z){var L;f==="playing"&&(f="gameover",(L=document.exitPointerLock)==null||L.call(document),u=Math.max(u,v),localStorage.setItem(vo,String(Math.floor(u))),d.showGameOver({reason:z,score:v,kills:x,waves:l.wavesCleared,time:p,best:u}))}function y(){h.consumeAction("light")&&c.light(),h.consumeAction("push")&&c.push(),h.consumeAction("heavy")&&c.heavy(),h.consumeAction("spin")&&c.spin(),h.consumeAction("slam")&&c.slam(),h.consumeAction("dodge")&&s.tryDodge()&&o.dodge(),h.consumeAction("jump")&&s.tryJump(),h.consumeAction("camera")&&s.cycleCamera();const z=h.isBlocking();z&&!_&&o.block(),_=z}function M(z){T=requestAnimationFrame(M);const L=Math.min(.05,(z-A)/1e3);if(A=z,f==="playing"){const{dx:G,dy:K}=h.consumeMouseDelta();s.applyLook(G,K),y(),s.update(L,h,r.clampToArena);const W=c.update(L);W>0&&(x+=W,v+=W*j.scorePerKill),l.update(L),a.update(L,s.position,r.gatePosition,D=>{const et=a.getPosition(D);s.takeDamage(j.enemyContactDamage,et.x,et.z)>0&&(o.hurt(),c.addShake(.12),v+=1),s.state.alive||P("player")},()=>{m=Math.max(0,m-j.enemyGateDamage),r.gateMesh.material.emissive.setHex(16729156),r.gateMesh.material.emissiveIntensity=.85,o.gateHit(),c.addShake(.08),m<=0&&P("gate")}),r.gateMesh.material.emissiveIntensity=Math.max(0,r.gateMesh.material.emissiveIntensity-L*2.5),l.phase==="fighting"&&(a.aliveCount>0&&(v+=j.scorePerSecondNear*L),p+=L),Pp(n,s,L),c.shake>0&&(n.position.x+=(Math.random()-.5)*c.shake,n.position.y+=(Math.random()-.5)*c.shake*.6),d.update({gateHp:m,gateMax:j.gateHp,hp:s.state.hp,hpMax:j.playerHp,score:v,wave:l.wave,kills:x,time:p,alive:a.aliveCount});const tt=m/j.gateHp;r.gateMesh.material.color.setRGB(.86*(.4+.6*tt),.21*tt,.27*tt)}else{a.update(L*.35,s.position,r.gatePosition);const G=z*25e-5;n.position.set(Math.sin(G)*14,8,Math.cos(G)*14),n.lookAt(0,1,-8)}t.render(e,n)}function R(){var z,L,G;(z=document.getElementById("btn-play"))==null||z.addEventListener("click",()=>w()),(L=document.getElementById("btn-retry"))==null||L.addEventListener("click",()=>w()),(G=document.getElementById("btn-menu"))==null||G.addEventListener("click",()=>{f="menu",a.clear(),d.showMenu()}),window.addEventListener("keydown",K=>{var W;K.code==="Escape"&&((W=document.exitPointerLock)==null||W.call(document),d.setHintVisible(!0))})}return R(),d.showMenu(),a.spawnWave(18,r.portalPosition,r.gatePosition),T=requestAnimationFrame(M),globalThis.__horde={player:s,isBlocking:()=>s.state.blocking,shieldPos:()=>({...s.shield.position})},{start:w,dispose(){cancelAnimationFrame(T),h.dispose(),window.removeEventListener("resize",B),t.dispose()}}}const Op=document.getElementById("game");Fp(Op);
